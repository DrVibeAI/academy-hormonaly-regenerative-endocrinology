...
34. **m03** — Jurisdiction — both guides are US-centred for incretin regulation; module 03 asserts US status only (FDA labels, Drugs@FDA, FDA statement current 1 September 2026). MHRA/EMA status of Wegovy, Mounjaro and compounded GLP-1 products is not asserted and needs mapping for the SEASON London edition.
...
The evidence, grades and regulatory status are the same for everyone. What changes is the 'what you do next' at the end of each lesson, so it fits what your licence lets you do.
