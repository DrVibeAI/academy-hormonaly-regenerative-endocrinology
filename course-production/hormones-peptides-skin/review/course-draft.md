...
- **m01** · m1-p02 (2026-09-25) — Role picker no longer says regulatory facts are the same for everyone: 'The evidence and grades are the same for everyone, and regulatory notes follow the country you choose. What changes with your role…' (six-jurisdiction course).
...
- **m02** · m2-p11 (2026-09-25) — UK text moved verbatim into the UK note; the same UK facts left beats 1 and 3 and the narration, and the UK-only lines left the prescriber and advisor versions (advisor sentence rejoined as approved on 24 Sep), so the base copy is the approved US text; EU, Portugal, Brazil and UAE notes added.
- **m02** · m2-p11 (2026-09-25) — EU note: the opening clause 'HRT is authorised nationally' removed; the cited EU core product information (CMDh, December 2025) lists HRT's indications but says nothing about how HRT products are authorised. The note now states only what that text lists.
...
- **m03** · m3-p08 (2026-09-25) — UK text moved verbatim into the UK note (the body sentence; the same UK fact removed from beat 3 and the narration, which is back to the approved wording) and the UK sources with it; EU, Brazil and UAE notes added.
- **m03** · m3-p09 (2026-09-25) — UK text moved verbatim into the UK note (the UK row's label and value joined into one opening sentence, its note verbatim) and the UK sources with it; body's UK clause and 'EU status is not covered' removed, US sentence as approved 24 Sep; EU, Portugal, Brazil and UAE notes added.
- **m03** · m3-p11 (2026-09-25) — UK text moved verbatim into the UK note and the UK sources with it; regulatory row label back to 'Regulatory status (US, September 2026)' as approved 24 Sep. No EU, Portugal, Brazil or UAE note: no verified source on hair-loss labelling there.
- **m03** · m3-p17 (2026-09-25) — EU, Brazil and UAE notes added (tirzepatide indications; BPC-157 status, with Dubai and Abu Dhabi rules). UK clause in the tirzepatide feedback left in place: it shares one sentence with the US statement.
- **m03** · m3-p18 (2026-09-25) — UK text moved verbatim into the UK note (the narration sentence) and the UK sources with it; the UK-only sentence removed from the prescriber version, now covered by the UK note; EU, Portugal, Brazil and UAE notes added.
- **m03** · unit tutorContext (2026-09-25) — 'EU not covered' removed; the moments' country notes now carry EU, Portugal, Brazil and UAE status.
- **m03** · m3-p18 (2026-09-25) — Sources only, no wording changed: the Cochrane review of probiotics for eczema (Makrgeorgou 2018) and the 503A bulks list (21 CFR 216.23) added to the citations and source line; they state the narration's eczema and BPC-157 sentences, which the previously cited sources did not.
...
- **m04** · m4-p05 (2026-09-25) — UK text moved verbatim into the UK note (row label back to 'Regulatory status (US, 14 May 2026)'; its 'UK, September 2026' date now closes the note; the UK source ids and the sourceNote's UK part moved from the block to the note). EU, Portugal, Brazil and UAE notes added.
- **m04** · m4-p06 (2026-09-25) — UK text moved verbatim into the UK note: the body's UK sentence and the prescriber version's UK clause (removed from the role note, which keeps its US line); the narration's UK sentence removed, so the narration is back to its approved text; UK source ids and the sourceNote's UK part moved from the block to the note. EU, Portugal, Brazil and UAE notes added.
- **m04** · m4-p11 (2026-09-25) — UK text moved verbatim into the UK note (the body's three UK sentences); the narration's four UK sentences removed (the earlier 'UK and EU rules are being mapped' line is not restored); UK source ids and the sourceNote's UK part moved from the block to the note. EU, Portugal, Brazil and UAE notes added.
- **m04** · m4-p16 (2026-09-25) — UK text moved verbatim into the UK note (the pointer to lesson 7.2, with its MHRA source id). EU, Portugal, Brazil and UAE notes added.
- **m04** · m4-p17 (2026-09-25) — EU, Portugal, Brazil and UAE notes added (research-use-only products bought online; registration status of GHK-Cu, BPC-157 and TB-500).
- **m04** · m4-p02 (2026-09-25) — Role line no longer says regulatory status is the same for everyone: 'The evidence and grades are the same for everyone, and regulatory notes follow the country you choose. What changes with your role…' (six-jurisdiction course).
- **m04** · m4-p05 (2026-09-25) — Source line drops the internal word 'Registry m04 ·'; now reads 'FDA 503A category list, updated 14 May 2026'.
...
- **m05** · m5-p03 (2026-09-25) — UK text moved verbatim into the UK note; block sources back to the approved list (the UK sources now sit on the UK note); EU, PT, BR and AE notes added.
- **m05** · m5-p05 (2026-09-25) — UK text moved verbatim into the UK note; the UK lines in beat 2 and the narration removed, restoring their approved wording; block sources back to the approved list; EU, PT, BR and AE notes added. The prescriber version's UK finasteride steps stay (they are not in the UK note).
- **m05** · m5-p08 (2026-09-25) — UK text moved verbatim into the UK note (row 3 note; 'UK licensed' dropped from the row value, which the UK note states); block sources back to the approved list; EU, PT, BR and AE notes added.
- **m05** · m5-p12 (2026-09-25) — 'EU status is not covered in this course' removed; EU, PT, BR and AE notes added on Melanotan II; the approved UK row stays in the comparison table.
- **m05** · m5-p17 (2026-09-25) — UK text moved verbatim into the UK note; the UK line in the narration removed; block sources back to the approved list; EU, PT, BR and AE notes added. The prescriber version's UK specials line stays (it is not in the UK note).
- **m05** · unit tutorContext (2026-09-25) — Removed 'EU status not asserted' and 'EU not covered'; EU, Portugal, Brazil and UAE status now sits in the moments' jurisdiction notes.
...
- **m06** · m6-p05 (2026-09-25) — UK text moved verbatim into the UK note (the body sentence; the same UK sentence also left point 3, beat 3 and the narration); EU, PT, BR and AE notes added.
- **m06** · m6-p08 (2026-09-25) — UK text moved verbatim into the UK note (the 'UK status' tool row, its label, value and note joined); EU, BR and AE notes added.
- **m06** · m6-p11 (2026-09-25) — EU, PT, BR and AE notes added.
- **m06** · m6-p12 (2026-09-25) — UK text moved verbatim into the UK note (the body sentence; the same UK sentence also left beat 3 and the narration; the UK-only sentence left the prescriber version, its specials clause kept verbatim in the UK note); EU, PT, BR and AE notes added.
- **m06** · unit tutorContext (2026-09-25) — Removed 'EU not covered.'; the Guide reads the jurisdiction notes directly.
...
- **m07** · m7-p07 (2026-09-25) — EU, PT, BR and AE regulatory notes added (pharmacy preparation and compounding rules); US base copy unchanged.
- **m07** · m7-p08 (2026-09-25) — EU, PT, BR and AE regulatory notes added (status of BPC-157, TB-500, KPV, GHK-Cu, LL-37 and melanotan); US base copy unchanged.
- **m07** · m7-p09 (2026-09-25) — EU, BR and AE regulatory notes added (tesamorelin status); no PT note, the EU note covers Portugal; US base copy unchanged.
- **m07** · m7-p21 (2026-09-25) — Rebuilt as the outside-the-US moment (id kept): lead, title, body, tool rows, callout and sources now state what holds across the non-US jurisdictions; UK text moved verbatim into the UK note; EU, PT, BR and AE notes added.
- **m07** · m7-p13 (2026-09-25) — EU, PT, BR and AE regulatory notes added (research-use-only products and unauthorised supply); US base copy unchanged.
- **m07** · m7-p22 (2026-09-25) — Rebuilt as the outside-the-US moment (id kept): lead, title, body, points, audio beats, narration and sources now state what holds across the non-US jurisdictions; UK text moved verbatim into the UK note; EU, PT, BR and AE notes added.
- **m07** · m7-p15 (2026-09-25) — EU, PT, BR and AE regulatory notes added (off-label use and unauthorised medicines); US base copy unchanged.
- **m07** · m7-p16 (2026-09-25) — UK text moved verbatim into the UK note (its MHRA source moved with it); EU, PT, BR and AE regulatory notes added.
- **m07** · m7-p17 (2026-09-25) — EU, PT, BR and AE regulatory notes added (BPC-157 status and compounding); US base copy unchanged.
- **m07** · m7-p18 (2026-09-25) — EU, PT, BR and AE regulatory notes added; UK chart wording left in place because each row pairs the US and UK examples in one cell.
- **m07** · unit tutorContext (2026-09-25) — 'EU not covered' removed from the unit tutorContext; the Guide reads each moment's jurisdiction notes.
- **m07** · m7-p01 (2026-09-25) — Module opener: regulatory detail now given for the US in the lesson text and for the UK, EU, Portugal, Brazil and the UAE in each moment's regulatory note (was: US and UK; 'EU rules are not covered').
- **m07** · m7-p20 (2026-09-25) — Commitment chip and suggestion: check live status 'with my national regulator (for example FDA or MHRA)' instead of FDA or MHRA only.
...
1. **m01** — A&RE ch.7 ref 1 — the Hormone Cell Atlas is now in print: Fei L, Huang-Doran I, et al. Science 2026;393(6806):eaeb2672 (2 Jul 2026), PMID 42207862. The guide's 'published online May 28, 2026' matches the PubMed entry date.
2. **m01** — A&RE ch.7 — the figures '~74% of cell types predicted to produce, and 93% to respond to, at least one hormone' and 'endocrine identity tracks cellular lineage more than tissue of origin' could not be verified from the abstract, the atlas portal or press coverage (full text and supplement paywalled). The course teaches only the abstract- and portal-level facts (379 genes, ~14 million cells and nuclei, 47 tissues). Please confirm these against the paper's text.
3. **m01** — A&RE ch.7 testing pearl — 'serum 25-OH vitamin D … falls with low UVB exposure and sunscreen use regardless of oral intake': Neale et al. 2019 (Br J Dermatol, systematic review) found little evidence that real-life sunscreen use lowers 25(OH)D (the two randomized field trials, SPF ~16, showed no effect; high-SPF products untested), and dietary or supplemental vitamin D is itself converted to 25(OH)D (Bikle 2014), so 'regardless of oral intake' does not hold. The course teaches the trial evidence and keeps sun-protection advice unchanged.
4. **m01** — A&RE ch.7 senescence paragraph — 'blunting neighboring cells' responsiveness to estrogen, IGF-1, and retinoids, while estrogen loss at menopause is itself associated with a heavier senescent burden and slower fibroblast turnover [4,6]' and 'correcting a true deficiency works partly by easing the senescent … state': neither cited source addresses this (Slominski & Wortsman 2000; Wang & Dreesen 2018, full text read), and a targeted PubMed search found no human study. The course does not teach these statements.
5. **m01** — A&RE ch.7 — 'SASP-driven MMPs degrade dermal collagen' is stated as established. The human evidence is that aged dermis has more fibroblast MMP-1 and fragmented collagen (Fisher 2009; Varani 2006) and that senescent cells secrete MMPs in culture (Coppé 2008); that senescent cells are the main source in living skin is plausible, not shown. Suggest 'are thought to'.
6. **m01** — A&RE ch.17 internal inconsistency — the text and table grade senolytics' human evidence GRADE C, while the 'three things to remember' strip says senolytics have 'no human outcome data (D)'. The underlying studies (open-label pilots of 9 and 14 patients, biomarker endpoints) fit D for any clinical claim; the course says so and adds that no adequately sized trial with skin-ageing outcomes was found (September 2026); the one exploratory topical-rapamycin RCT described clinical change only qualitatively.
7. **m01** — A&RE ch.6 — 'Independent work shows keratinocyte-derived, de novo glucocorticoids actively police local immune tone' (Phan 2021): the functional evidence is from mice (keratinocyte Cyp11b1 deletion). Worth naming the species, as the chapter does elsewhere ('cell and ex-vivo').
8. **m01** — A&RE ch.5 — 'reduces collagen by roughly 1% per year' (ref 1, Shuster 1975): the abstract confirms that skin collagen falls with age and is lower in women but gives no annual rate, and the full text was not accessible. The course does not quote the 1% figure; please confirm the source of the rate.
9. **m01** — A&RE ch.5 — 'retinoids … remain first-line GRADE A' carries no citation. Suggested primary: Sitohang et al. 2022 (systematic review of 7 RCTs of topical tretinoin for photoageing, PMID 35620028); for naturally aged skin, Kafi et al. 2007 (RCT, PMID 17515510).
10. **m01** — Not in either guide, worth adding — Ressler 2006 and Waaijer 2016 (senescent cells in human skin, and their link with wrinkles and perceived age), Fisher 2009 and Varani 2006 (the MMP-1–collagen fragmentation loop in aged human dermis), Coppé 2008 (the SASP primary), Chung 2019 (the one randomized human-skin senomorphic study), Hughes 2013 (sunscreen RCT, photoageing), Neale 2019 (sunscreen and vitamin D), and the atlas portal's own statement that its predictions are 'putative and hypothesis-generating'.
11. **m01** — Baker 2016 (2026-09-24, from the claim-support full-text read): clearing p16-positive cells during wound healing slowed wound closure in mice (Extended Data Fig. 10), consistent with transient senescence aiding repair (Haykal 2026). This is worth a line in A&RE ch.13/17, where senolytics are discussed for skin.
12. **m02** — A&RE ch.9 — 'skin collagen falls … on the order of 30% within the first five years, then roughly 2% per year' (refs 1 and 3, both reviews). The primary biopsy studies it traces to report 1–2% a year tracking years since menopause (Brincat 1985, PMID 3978054; Brincat 1987, PMID 3120067; Affinito 1999, PMID 10656502); none of their abstracts states the 30% figure, which appears in reviews (e.g., Thornton 2013). The course teaches 1–2% a year and names 30% as a review figure. Suggest citing the primary study that reports it, or dropping it.
13. **m02** — A&RE ch.9 grades the skin effect of MHT GRADE B, citing the NAMS 2022 statement. NAMS itself rates that key point Level II (limited or inconsistent) on the strength of one review. The largest RCT of HT on facial skin (Phillips 2008, n=485, PMID 18625536) and the 4-year KEEPS skin study (Owen 2016, PMID 27393520) found no difference in wrinkles; neither is cited by the guide. The course grades structural effects (thickness, collagen) C and says a visible wrinkle benefit has not been shown in the largest trials. The guide may wish to revisit B.
14. **m02** — A&RE ch.9 ref 8 (Pivazyan 2023) — pools small, heterogeneous studies including non-randomized ones (I² 64–98%), omits KEEPS, and its own authors say MHT should not be considered an independent treatment for skin ageing. Suggest describing it as low-certainty support.
15. **m02** — A&RE ch.8 'cortisol face' — the opening description of the 'genuine endocrine entity' leads with moon facies and dorsocervical/supraclavicular fat pads, which the Endocrine Society guideline (Nieman 2008, Table 1) lists among common, less discriminatory features; its best discriminators are easy bruising, facial plethora, proximal myopathy and reddish-purple striae >1 cm. The chapter's clinical pearl already lists the right red flags; suggest the description lead with them.
16. **m02** — A&RE ch.8 — worth adding the guideline's first step: a drug history for exogenous glucocorticoids, including topical and skin-bleaching creams, herbal tonics and joint or nerve injections (Nieman 2008, 3.1), since iatrogenic Cushing's is the commonest form and the most relevant to aesthetic practice.
17. **m02** — A&RE inherited-syndromes chapter — the Carney complex entry omits cardiac myxomas, present in 20–40% of patients and responsible for more than half of disease mortality (Correa 2015, PMID 26130139). They are the main reason a lentigines-plus-myxoma pattern is a referral. PRKAR1A '~70%' matches Correa 2015 ('more than 70%').
18. **m02** — A&RE ch.9 — 'topical estrogen creams … are absorbed systemically' is not stated in the cited review's abstract (Shu & Maibach 2011) and was not verified; the course teaches the US regulatory position instead (21 CFR 310.530: an OTC 'hormone cream' is an unapproved new drug).
19. **m02** — A&RE ch.9 and ch.14 — FDA's menopausal hormone therapy labeling action (request 10 Nov 2025; first six approved labels 12 Feb 2026: cardiovascular, breast-cancer and probable-dementia statements removed from the boxed warning) is not mentioned. Suggest adding it, date-stamped, because it changes how the risk conversation is framed; approved indications did not change and do not include skin.
...
| | | |
|---|---|---|
| Steroid synthesis | Cholesterol to cortisol, androgens and estrogens | CYP11A1 starts the chain; 11β-HSD1, 5α-reductase and aromatase activate precursors from the blood. Cell and tissue studies. |
| HPA-like loop | CRH → ACTH → cortisol, with feedback | Human scalp follicles kept alive in culture. Ex vivo, human tissue. |
| Keratinocyte glucocorticoids | Set local immune tone | Genetic deletion in mouse keratinocytes. Animal evidence. |
| Thyroid-like loop | TRH, TSH and deiodinases → T3 | Keratinocyte growth and the hair cycle. Mostly mouse models. |
| Somatotropic loop | GH and IGF-1 | Human hair follicles, ex vivo. |
| Melanocortins | POMC → α-MSH, ACTH, β-endorphin | Pigment, barrier and local immune restraint. Module 05 returns to this. |
...
| | | |
|---|---|---|
| Local loop | Made and used in the skin | Between neighbouring cells, back on the same cell, or inside it |
| Body to skin | A circulating hormone acting on skin | The skin finding can be the visible sign of a systemic disorder |
| Skin to body | A skin product entering the circulation | The skin acting as an endocrine gland for other organs |

**Callout:** Before you treat a skin finding, decide which direction it runs.
...
| | | |
|---|---|---|
| Transcript | The cell carries the RNA | Single-cell atlases; a prediction to confirm |
| Function in tissue or animals | The pathway works | Human tissue kept alive in culture, or animal models |
| Human, in vivo | It happens in living people | Measured in people, in the body |

**Callout:** Each rung needs the one below it, and advice to a patient needs the top one.

**Exercise (classify) · How far up?** — Tap the highest rung each finding reaches.
- A skin cell type scores high as a hormone producer in a single-cell RNA atlas → **Transcript prediction** — *Transcript. The score comes from RNA; the atlas's authors call such predictions putative until validated.*
- Scalp hair follicles kept alive in culture secrete cortisol and switch off their own CRH → **Function in tissue or animals** — *Function in human tissue. The loop works ex vivo; whether it shapes hair growth in a living scalp is a further step.*
- A brochure says skin 'has receptors for' a hormone, citing an RNA atlas → **Transcript prediction** — *Transcript. A receptor gene on a map is where the question starts, and where this brochure stops.*
...
**Q.** A brochure for a hormone-containing serum cites a single-cell atlas showing that dermal fibroblasts carry the RNA for that hormone's receptor. What does that finding establish?
- ✗ That the serum reaches those fibroblasts and improves the skin. — *That needs penetration data and a clinical trial; an RNA map provides neither.*
- ✗ That skin secretes the hormone and needs it replaced when levels fall. — *The finding concerns a receptor, and RNA says nothing about secretion or deficiency.*
- ✔ That fibroblasts may respond to the hormone: a hypothesis to confirm at the protein, function and clinical level. — *Correct. The atlas's authors call such predictions putative and hypothesis-generating.*
...
**3 years** — younger-looking: fewest versus most p16-positive epidermal cells, at the same chronological age (Waaijer et al., 2016 — 178 adults aged 45–81, Leiden Longevity Study, sun-protected arm biopsies)  
*Means:* Senescent-cell burden in human skin tracks visible ageing, even in skin that sees little sun.  
*Does not mean:* It does not show that senescent cells cause wrinkles, or that removing them would reverse any. One observational cohort shows an association.
...
| | | |
|---|---|---|
| Mechanism | A collagen-fragmentation loop | Skin collagen falls with age. Aged human dermis shows more fibroblast MMP-1 and fragmented collagen; in culture, fragmentation raises MMP-1 further. That senescent cells drive this in living skin is plausible, not shown. |
| Human evidence | Association | p16-positive cells rise with age and track with wrinkles and perceived age |
| Animal evidence | Causation, in mice | Clearing p16-positive cells, or giving senolytic drugs, extends healthy lifespan in mice. Skin was checked only for safety, and clearing these cells during healing slowed wound closure. |
| Open question | Do senotherapies change human skin? | Small pilots measuring tissue markers. One exploratory randomized trial of topical rapamycin (36 enrolled, 19 dropped out) lowered skin p16, and clinical change was only described. No adequately sized trial with clinical skin-ageing outcomes was found (September 2026). |
...
A 58-year-old patient has read that senolytic supplements 'clear zombie cells' and reverse skin ageing, and asks whether to start one she found online. She does not use sunscreen daily.

- ✗ Support a trial of the supplement: senescent cells clearly age skin, so clearing them should help. — *The human evidence is an association and the clearing evidence is in mice. No trial has tested senolytics on skin-ageing outcomes.*
- ✔ Explain what is known in people and what only in mice, point her to the measures with trials (daily sunscreen, and a topical retinoid discussed with a prescriber), and mention that senolytics are being studied in trials. — *Right. It keeps the registers apart and moves her toward the levers with human outcome data. The guide advises that senolytics generally be confined to clinical trials.*
- ✗ Tell her senescence is a mouse phenomenon with no relevance to human skin. — *Senescent cells are measurable in human skin and track with wrinkles and perceived age. The biology is real; the treatment evidence is what is missing.*
...
**Q.** Which statement about senescence and skin ageing matches the evidence?
- ✗ Randomized trials show that senolytics reverse human skin ageing. — *No randomized trial of a senolytic with clinical skin-ageing outcomes was found. Human data are small pilots measuring tissue markers.*
...
**By role**
- *Prescriber:* Your checklist ends with the systemic screen: a skin sign that points to an endocrine disorder is assessed or referred before any cosmetic plan.
...
**Q.** Closing Module 1 (fictional case). A 41-year-old with a low serum 25-hydroxyvitamin D says she will stop sunscreen because 'skin makes vitamin D'. Which reply keeps the physiology and the evidence straight?
- ✗ Vitamin D made in skin stays in the skin, so sunscreen cannot affect her blood level. — *Skin-made vitamin D3 enters the circulation: the skin is acting as an endocrine gland for the whole body.*
- ✔ Skin synthesis does feed her blood level, but field trials of daily sunscreen did not lower 25-hydroxyvitamin D; keep sun protection and treat the low level as its own clinical question. — *Correct. The signal runs skin to body, and the human trials, not the mechanism alone, set the advice.*
- ✗ The guide says sunscreen lowers vitamin D, so stopping it is reasonable. — *Real-life trials did not show a fall, and the guide itself says this biology never licenses unprotected sun exposure.*
...
- Local axis: CRH, POMC and ACTH are made in skin
- 11β-HSD1 regenerates cortisol inside skin cells
- Mechanism register: human samples, cultured cells and mice

<details><summary>Narration script</summary>

Picture the skin as a small endocrine organ with its own stress axis. Skin cells make CRH and ACTH, the same signals that drive the adrenal glands, and they carry the receptors to respond to them. They also carry an enzyme called eleven beta HSD one, which turns inactive cortisone back into active cortisol inside the cell. In human skin samples that enzyme works harder with age and in sun-exposed skin, and it sets local cortisol independently of the level in the blood. Cortisol slows collagen production in dermal fibroblasts, and mice bred without the enzyme kept their dermal thickness as they aged. Hold all of this in the mechanism register. It comes from biopsies, cultured cells and mice, and it says nothing yet about how a patient's face will age.
...
| | | |
|---|---|---|
| Mechanism | Plausible | Enzyme activity rises with age and sun exposure in human skin samples; knockout mice resist age-related dermal thinning |
| Human evidence | One pilot RCT · GRADE C | 28 adults with type 2 diabetes took an oral inhibitor: the primary outcome was missed, wounds closed faster in an exploratory analysis, and barrier function was modestly worse |
...
| | | |
|---|---|---|
| Easy bruising | Skin | Bruises without an obvious injury |
| Facial plethora | Face | A persistently red, full-blooded complexion |
| Proximal muscle weakness | History and examination | Trouble rising from a chair or climbing stairs |
| Striae | Abdomen, flanks, thighs | Reddish-purple and wider than 1 cm |
| Facial fullness | Face | A rounder face than a year ago |
| Weight gain | History | Gradual gain over several years |
| Acne or hirsutism | Skin | New or persistent |
| Fatigue and poor sleep | History | Tired, sleeping badly |

**Callout:** Few features of Cushing's syndrome are unique. Some discriminate far better than others.

**Exercise (classify) · Discriminating or common?** — Tap where each feature belongs.
- Easy bruising → **Best discriminates Cushing's** — *One of the four features the guideline lists as best discriminating, particularly bruising with no obvious trauma.*
- Facial plethora → **Best discriminates Cushing's** — *Listed among the best discriminators. Most of the four have low sensitivity, so their absence does not exclude the syndrome.*
- Proximal muscle weakness → **Best discriminates Cushing's** — *Proximal myopathy is one of the four; ask about stairs and getting up from a low chair.*
- Striae → **Best discriminates Cushing's** — *The guideline singles out striae that are reddish-purple and wider than 1 cm.*
- Facial fullness → **Common, less discriminating** — *The guideline lists facial fullness, like the dorsocervical fat pad, among features that are common in the general population. A round face alone is a weak signal.*
- Weight gain → **Common, less discriminating** — *Common and less discriminatory on its own; many features of cortisol excess are shared with ordinary obesity.*
- Acne or hirsutism → **Common, less discriminating** — *Both sit on the guideline's common, less discriminatory list; persistent hirsutism more often points to androgen excess (lesson 2.3).*
- Fatigue and poor sleep → **Common, less discriminating** — *Fatigue, insomnia and poor concentration are common and less discriminatory.*
...
**2–3** — new cases of endogenous Cushing's syndrome per million people per year (European population studies) (As cited in the Endocrine Society diagnostic guideline, 2008)  
*Means:* A round, puffy face in an aesthetic clinic is almost always something other than Cushing's syndrome, and when cortisol excess is real it most often comes from a glucocorticoid the patient is already using.  
*Does not mean:* It does not mean you can dismiss it. The guideline recommends testing when discriminating features are multiple and progressive or unusual for age, and some groups, such as people with poorly controlled diabetes, carry a higher rate.
...
- Drug history first, including creams and injections
- Look for bruising, plethora, proximal weakness, wide purple striae
- Refer for testing; skip supplements and consumer panels

**By role**
- *Prescriber:* If discriminating features are present, arrange one of the guideline's first-line tests or refer directly to endocrinology, and document the drug history, including creams and injections. An abnormal result goes to an endocrinologist.
- *Clinical staff:* Record any steroid creams, skin-lighteners or injections the patient mentions, note bruising or wide purple striae you see, and bring it to the prescriber before the next treatment.
- *Advisor:* Do not recommend 'cortisol-lowering' supplements or consumer cortisol kits. If a patient describes easy bruising, muscle weakness or new wide purple stretch marks, point them to a prescriber.

<details><summary>Narration script</summary>

Here is how that plays out when a patient asks about cortisol face. Begin with a drug history, because the commonest cause of cortisol excess is a glucocorticoid someone is already using. The guideline names the easy ones to miss, such as skin-bleaching creams, herbal tonics, and joint or nerve injections. Then look for the four features that shift the odds, meaning easy bruising, a plethoric face, weakness in the hips and shoulders, and wide reddish-purple striae. Without them, the Aesthetic and Regenerative Endocrinology guide reads most puffiness as sleep, alcohol, salt and fluid, and the Endocrine Society advises against testing everyone. With them, and especially when they are progressing, the patient needs formal testing and an endocrinologist. A cortisol supplement or a mail-order saliva panel answers the wrong question.
...
**Q.** A 38-year-old asks whether her puffy morning face is 'cortisol face'. She sleeps badly and drinks most evenings. What is the best next step?
- ✗ Recommend a consumer saliva cortisol panel to check her levels. — *Testing is for multiple, progressive discriminating features; the guideline advises against widespread testing and random cortisol measures, and the guide calls consumer panels poorly validated.*
- ✔ Take a drug history, including creams and injections, and examine for bruising, plethora, proximal weakness and wide purple striae; refer if they are present. — *Correct. Exclude exogenous glucocorticoids, then look for the discriminating features before anyone orders a test.*
- ✗ Reassure her that Cushing's syndrome is too rare to consider. — *It is rare, but the guideline asks you to consider it when discriminating features cluster; reassurance comes after the history and examination.*
...
- Receptors: ERα, ERβ and GPER in aged and photoaged skin
- Topical estradiol raises collagen in sun-protected skin only
- Collagen loss follows years since menopause

<details><summary>Narration script</summary>

Estrogen is the hormone the guide says dominates the visible ageing of women's skin, so start with what it does in the dermis. Skin carries estrogen receptors in sun-protected and sun-damaged sites alike. In a vehicle-controlled study, two weeks of topical estradiol raised collagen production in the hip skin of postmenopausal women; in photoaged forearm and facial skin, the same treatment made no measurable difference. Small biopsy studies from the nineteen eighties and nineties found that skin collagen and thickness fall after menopause, and that the fall follows years since the last period more closely than birthdays. Keep two questions apart as you go. One is what estrogen does in the dermis. The other is whether giving it changes how a face ages, and those answers come from different trials.
...
**1–2%** — fall in skin collagen content and thickness per year after menopause (small biopsy studies) (Brincat et al., 1987 — in parallel with bone mass)  
*Means:* Estrogen withdrawal is a measurable contributor to dermal thinning, and it follows the menopause clock rather than age alone.  
*Does not mean:* It does not show that hormone therapy restores a younger-looking face. These are small observational studies, mostly of non-facial skin; the treatment trials come next.
...
| | | |
|---|---|---|
| Systemic HT · skin thickness and collagen | Increased · GRADE C | Two small RCTs (60 and 41 women) measured hip and upper-arm skin |
| Systemic HT · facial wrinkles | No difference · GRADE B | 485 women for 48 weeks on low-dose therapy; a four-year trial in recently menopausal women also found no difference |
| Pooled analysis (2023) | Positive, heterogeneous · GRADE C | Small studies, some non-randomized, varying widely; its authors do not propose hormone therapy as a skin treatment |
| Topical estrogen on the face | Small and mixed · GRADE C | One 24-week RCT improved thickness and fine lines; a biopsy study found no collagen response in photoaged facial skin |
| Topical estrogen · acute wounds | Faster healing · GRADE C | A small randomized study in healthy older adults |

**Callout:** A thicker dermis on biopsy and a younger-looking face are different outcomes. Ask which one a trial measured.
...
**Q.** A 52-year-old with no hot flashes, no sleep disturbance and no vaginal symptoms asks for estrogen 'to stop my face ageing'. What does the evidence support?
- ✗ Estrogen rebuilds collagen, so hormone therapy is a reasonable anti-ageing choice. — *That is the mechanism talking. Small trials show thicker skin, the largest trials found no difference in wrinkles, and skin is not an approved indication.*
- ✗ A compounded 'bioidentical' estrogen face cream avoids the risks of systemic therapy. — *Compounded 'bioidentical' preparations lack efficacy and safety data and carry quality concerns; the menopause society says preference alone should not justify them.*
- ✔ Skin alone is not a reason to start hormone therapy; offer skin-directed care such as daily sunscreen and a retinoid, and revisit therapy if menopausal symptoms appear. — *Correct. Symptoms decide hormone therapy. For skin, daily sunscreen has a large trial behind it and one tretinoin cream is FDA-approved as an adjunct for fine wrinkles.*
...
- MEN1: facial angiofibromas, collagenomas
- Carney complex: lip and eyelid lentigines, myxomas
- MEN2A: lichen amyloidosis between the shoulder blades

<details><summary>Narration script</summary>

Some endocrine syndromes are written on the skin years before the glands give them away. In multiple endocrine neoplasia type one, most patients in one careful series had several facial angiofibromas, the same lesions seen in tuberous sclerosis, along with collagenomas on the trunk. In Carney complex, usually caused by inactivating variants in the PRKAR1A gene, freckle-like lentigines cluster on the lips, eyelids and the corners of the eyes, alongside blue naevi and small skin myxomas. The same patients can develop myxomas in the heart and cortisol-secreting adrenal disease. In MEN two A, an itchy, rippled, darkened patch between the shoulder blades, called cutaneous lichen amyloidosis, can appear long before medullary thyroid cancer. Each of these is a referral finding, and none of them is yours to diagnose alone.
...
**88%** — of 32 people with MEN1 had multiple facial angiofibromas (Darling et al., 1997 — collagenomas in 72%)  
*Means:* Multiple facial angiofibromas are common in MEN1 and can be its first visible sign; in someone without tuberous sclerosis they are a reason for endocrine testing, whatever the cosmetic plan.  
*Does not mean:* It does not mean a single facial papule is MEN1. This is one small referral-centre series, and angiofibromas have other causes, tuberous sclerosis above all.
...
- Darkening in creases, scars and gums: adrenal insufficiency
- Rapid hirsutism or virilization: exclude a tumour
- Acanthosis, pretibial plaques, dry cool skin: metabolic and thyroid
...
| | | |
|---|---|---|
| Urgent assessment | Before any cosmetic treatment | Findings that suggest a hormone-secreting tumour or an adrenal crisis |
| Endocrine referral | Planned work-up | Findings that point to treatable or inherited endocrine disease |
| No endocrine flag on this alone | Skin-directed care | Common findings without discriminating features; reassess if others appear |
...
- Itchy, rippled brown patch between the shoulder blades; an aunt had thyroid cancer → **Endocrine referral** — *Interscapular lichen amyloidosis clusters with RET variants in MEN2A and can precede medullary thyroid cancer; with that family history it needs endocrine and genetic assessment.*
- Puffy face after late nights; no bruising, striae or weakness → **No endocrine flag alone** — *Facial fullness alone is a common, weakly discriminating feature, and the guideline advises against testing everyone. Reassess if discriminating features appear.*
- A few coarse hairs on the chin only; regular periods → **No endocrine flag alone** — *The Endocrine Society suggests against androgen testing in women with regular cycles and unwanted local hair without an abnormal hirsutism score. Hair removal is a reasonable cosmetic choice.*
...
- Lip and canthal lentigines: typical of Carney complex
- Eyelid papule: a possible cutaneous myxoma
- A family heart tumour: the reason not to wait

**Exercise (scenario) · What do you do first?** — 

A 29-year-old asks for laser removal of 'freckles' on her lips and at the corners of her eyes before her wedding. You notice a soft, skin-coloured papule on one eyelid. She mentions her father had 'a heart tumour' removed in his thirties.

- ✗ Proceed with the laser: lentigines are benign and she has a deadline. — *The spots may well be benign. Their distribution, the eyelid papule and the family history are what matter, and together they flag a possible syndrome.*
- ✔ Pause the cosmetic plan, document the findings and family history, and refer her promptly for endocrine and genetic assessment. — *Right. Canthal and lip lentigines with a possible myxoma and a family cardiac tumour fit Carney complex, where early echocardiographic screening matters. You route; the specialist diagnoses.*
- ✗ Order a cortisol test to check for Cushing's before deciding. — *Cortisol excess is one feature of Carney complex, but a single test neither assesses the syndrome nor its cardiac risk. Referral comes first.*

Follow-up: Then explain why in plain words: the pattern of spots, the eyelid bump and her father's history together deserve a specialist's look, and the laser can wait.

**By role**
- *Prescriber:* Document the lentigines, the eyelid lesion and the family history, refer to endocrinology or clinical genetics, and leave echocardiography and testing to that assessment. Defer the laser until then.
- *Clinical staff:* Hold the booking, photograph with consent if your setting allows, record the family history in her words, and bring it to the prescriber the same day.
- *Advisor:* Explain that the pattern of spots is worth a specialist's look before any cosmetic treatment, and point her to a prescriber; do not suggest a product to fade them.

<details><summary>Narration script</summary>

Consider a fictional patient, built from this lesson's evidence. She is twenty-nine and wants the freckles on her lips and at the corners of her eyes lasered before her wedding. While you examine her you notice a soft, skin-coloured bump on one eyelid. She mentions that her father had a heart tumour removed in his thirties. Pigmented spots at the corners of the eyes are seen in Carney complex and Peutz–Jeghers syndrome, and small skin myxomas favour the eyelids and ears. In Carney complex, tumours of the heart cause more than half of the deaths, which is why screening matters once the diagnosis is suspected. The laser itself may be harmless. The question is what the skin is telling you. Choose your first move.
...
**Q.** A 31-year-old wants laser hair removal for coarse hair on her chin and chest that appeared over four months. Her voice has deepened. What comes first?
- ✗ Start the laser now and review her in three months. — *Rapid onset with virilization raises the likelihood of an androgen-secreting tumour; hair removal does nothing about it.*
...
**Q.** Closing Module 2: which statement keeps mechanism, evidence, regulation and the open question apart?
- ✗ Estrogen raises dermal collagen, so hormone therapy is indicated for skin ageing. — *That blends mechanism into indication. The collagen effect is real in small trials; the approved uses are symptoms and bone.*
- ✔ Estrogen acts on skin receptors (mechanism); small trials show thicker skin, while the largest found no wrinkle difference (evidence); US approved uses are symptoms and bone (regulation); whether longer treatment changes facial ageing is untested (open question). — *Correct. Four separate answers, each with its own source.*
- ✗ A round, puffy face is a sign of Cushing's syndrome and should be tested. — *Facial fullness is common and weakly discriminating; testing is for multiple, progressive discriminating features.*
...
- A second fat layer inside the dermis
- In mice: antimicrobial, and lost with age
- In people: a different shape, and an open question about ageing

<details><summary>Narration script</summary>

Most people picture skin fat as one layer under the dermis. There is a second, thinner layer inside the reticular dermis itself, called dermal white adipose tissue. In mice, this layer expands rapidly after a Staphylococcus aureus infection, and its new fat cells release cathelicidin, an antimicrobial peptide. Older mice lose much of that capacity, through TGF-beta signalling. Human skin arranges this fat differently, in small cones around hair follicles, and human acne lesions contain preadipocytes around the follicle that make cathelicidin. What the layer contributes to human skin ageing has not yet been measured. So hold two things apart when you hear about skin fat. The defence story is strong in mice and emerging in people. The ageing story in people is still a proposal.
...
**186** — pairs of identical twins compared for facial ageing (Guyuron et al., 2009 — a four-point higher BMI tracked with an older look before about 40 and a younger look after it)  
*Means:* From midlife on, facial fat goes with a younger-looking face. That fits the anatomy: the face ages partly as its fat compartments change. GRADE C, observational.  
*Does not mean:* It is an observational comparison of photographs. It does not show that gaining weight rejuvenates, or that fat loss on a drug changes the skin itself.
...
- Sugar + protein → Schiff base → Amadori product → AGE
- Cross-links stiffen long-lived collagen
- RAGE signalling: shown in the laboratory

<details><summary>Narration script</summary>

Glycation is chemistry before it is biology. Reducing sugars attach to the amino groups of proteins, rearrange into more stable products, and end as advanced glycation end products, known as AGEs. Dermal collagen lasts for years, so it collects AGEs, and they form cross-links that make the matrix stiffer. AGEs also bind a receptor called RAGE, which in laboratory studies switches on inflammatory signalling and enzymes that break down matrix. Keep the registers apart here. The chemistry, and the build-up of AGEs in human skin, are well documented. The idea that AGEs cause the wrinkles and laxity you see in clinic rests on laboratory and animal work plus human associations. The Aesthetic and Regenerative Endocrinology guide rates the structural and inflammatory effects grade B. This course grades the causal link D, and the next moment shows why.
...
**~15 years** — estimated half-life of human skin collagen (Verzijl et al., 2000 · AGE content of skin collagen rises about five-fold from age 20 to 85 (Dyer et al., 1993))  
*Means:* Glycation damage accumulates on the same collagen for years, and faster with higher glucose exposure. That much is measured in human skin: direct, observational, GRADE C.  
*Does not mean:* It does not show how much of visible ageing AGEs cause, or that any product reverses established cross-links. Skin autofluorescence is a surrogate reading of AGE load.
...
| | | |
|---|---|---|
| Dermal fat cells release cathelicidin to fight Staphylococcus aureus | Skin fat | Defence |
| Dermal fat loses its defensive capacity with age | Skin fat | Ageing |
| AGEs build up in skin collagen with age, faster in diabetes | Glycation | Accumulation |
| Skin collagen stays in place for many years | Glycation | Turnover |
| AGEs drive skin inflammation through their receptor, RAGE | Glycation | Signalling |
| An anti-glycation serum reverses cross-linked collagen | Glycation | Treatment |

**Callout:** Ask where a statement was shown: in mice, in human skin, or only on a label.

**Exercise (classify) · Mouse, human or marketing?** — Tap what stands behind each statement.
- Dermal fat cells release cathelicidin to fight Staphylococcus aureus → **Shown in mice or cells** — *Shown in mouse infection models (D). Human acne lesions contain preadipocytes that make cathelicidin, but protection against infection has not been tested in people.*
- Dermal fat loses its defensive capacity with age → **Shown in mice or cells** — *Shown in mice, through TGF-β signalling (D). The equivalent change in human skin has not been measured.*
- AGEs build up in skin collagen with age, faster in diabetes → **Shown in human skin** — *Measured directly in human skin biopsies (C, observational), and up to twice as high in type 1 diabetes.*
- Skin collagen stays in place for many years → **Shown in human skin** — *Human tissue analysis puts the half-life of skin collagen at about 15 years (C), which is why glycation damage accumulates.*
- AGEs drive skin inflammation through their receptor, RAGE → **Shown in mice or cells** — *Laboratory and animal work. The Aesthetic & Regenerative Endocrinology guide rates it B; the course grades the causal link D because the human data are associations.*
- An anti-glycation serum reverses cross-linked collagen → **Marketing only, not shown** — *Not shown. Trials of 'anti-glycation' products measure surrogate readings or appearance scores; none found for this course measured cross-links in human skin. The guide rates the evidence for these products C, on surrogate endpoints.*
...
**Q.** A patient shows you her skin autofluorescence reading, lower after eight weeks on an 'anti-glycation' supplement. What does that result show?
- ✗ The supplement has reversed glycation damage in her dermis. — *A lower surrogate reading is not a measurement of collagen cross-links, and the device was validated in non-pigmented skin.*
- ✔ A change in a surrogate marker; it shows nothing yet about collagen cross-links, how her skin looks or how it ages. — *Correct. The surrogate moved; the outcome is unknown.*
- ✗ Nothing at all, because glycation does not happen in human skin. — *It does: AGEs accumulate in human skin collagen with age and faster in diabetes. The question is what the product changed.*
...
**Regulatory status by jurisdiction**
- *GB:* In the UK both are licensed by the MHRA, and tirzepatide's diabetes and weight-management uses share one brand, Mounjaro. <sub>(Novo Nordisk A/S (marketing authorisation holder) 2026 · Novo Nordisk A/S (marketing authorisation holder) 2026 · Eli Lilly Nederland B.V. (marketing authorisation holder) 2026 · Medicines and Healthcare products Regulatory Agency (UK) 2023)</sub>
- *EU:* In the EU, semaglutide is a centrally authorised prescription medicine, as Ozempic and Rybelsus for diabetes and Wegovy for weight management (EMA and HMA, June 2024), and tirzepatide is authorised as Mounjaro (EU-wide, 15 September 2022) for diabetes and adult weight management, prescription-only. A search of the Union Register and EMA's medicines data on 25 September 2026 found no EU product named Zepbound. <sub>(eu-ema-glp1-shortages-2024 · eu-ema-epar-mounjaro · eu-union-register · eu-ema-medicines-data)</sub>
- *BR:* In Brazil, ANVISA has registered semaglutide as Ozempic (since 6 August 2018) and Wegovy (since 2 January 2023), with synthetic semaglutide pens registered from 26 May 2026, and tirzepatide as Mounjaro (since 25 September 2023); a search of its register on 25 September 2026 found no product named Zepbound. Since 23 June 2025, GLP-1 receptor agonist medicines may only be sold with retention of the prescription (RDC 973/2025 and IN 360/2025). <sub>(br-label-ozempic · br-anvisa-register-opendata · br-label-wegovy · br-anvisa-semaglutide-synthetic-2026 · br-anvisa-semaglutide-five-2026 · br-anvisa-consultas-medicamentos · br-label-mounjaro · br-anvisa-glp1-qa-2025 · br-anvisa-glp1-retention-2025)</sub>
- *AE:* In the UAE, the Emirates Drug Establishment (EDE) has been the federal authority regulating medical products since Federal Decree-Law 28/2023, and its register lists semaglutide as Ozempic, Rybelsus and Wegovy and tirzepatide as Mounjaro; every entry checked is a Prescription Only Medicine. A search of the EDE register on 25 September 2026 found no product named Zepbound. <sub>(ae-fdl-28-2023 · ae-ede-reg-wegovy · ae-ede-register · ae-ede-reg-mounjaro)</sub>
...
| | | |
|---|---|---|
| Ozempic (semaglutide) | Type 2 diabetes | First approved 2017. The label adds cardiovascular and kidney risk reduction in people with type 2 diabetes. |
| Wegovy (semaglutide) | Chronic weight management | Approved June 2021; adolescents from age 12 added December 2022. Cardiovascular risk reduction in established heart disease with obesity or overweight, March 2024. MASH with moderate to advanced liver fibrosis, accelerated approval, August 2025. |
...
**Regulatory status by jurisdiction**
- *GB:* In the UK (MHRA, September 2026), Ozempic is licensed for diabetes and Mounjaro for diabetes and weight. Wegovy is licensed for weight management and cardiovascular risk reduction; MHRA added weight management to Mounjaro in November 2023. MHRA says retatrutide is not authorised in the UK and anyone selling it does so illegally (24 July 2026), and in May 2026 it made its largest seizure of unlicensed weight-loss medicines. <sub>(Novo Nordisk A/S (marketing authorisation holder) 2026 · Novo Nordisk A/S (marketing authorisation holder) 2026 · Eli Lilly Nederland B.V. (marketing authorisation holder) 2026 · Medicines and Healthcare products Regulatory Agency (UK) 2023 · Medicines and Healthcare products Regulatory Agency (UK) 2026 · Medicines and Healthcare products Regulatory Agency (UK) 2026)</sub>
- *EU:* In the EU, semaglutide is authorised as Ozempic for diabetes (since 8 February 2018) and Wegovy for weight management (since 6 January 2022), and tirzepatide as Mounjaro for diabetes and adult weight management (since 15 September 2022), all prescription-only. In June 2024 EMA and HMA's shortage steering group said GLP-1 receptor agonists are not approved for, and should not be used for, cosmetic weight loss, and on 3 September 2025 EMA and HMA warned of a sharp rise in illegal medicines sold online and on social media as semaglutide, liraglutide or tirzepatide, which are unauthorised and may not contain the stated substance. <sub>(eu-ema-glp1-shortages-2024 · eu-ema-epar-ozempic · eu-ema-epar-wegovy · eu-ema-epar-mounjaro · eu-union-register · eu-ema-medicines-data · eu-ema-illegal-glp1-2025)</sub>
- *PT:* In Portugal, Wegovy and Mounjaro are authorised through the EU centralised procedure and are prescription-only, and on 4 July 2024 INFARMED stated that Ozempic, Trulicity and Victoza must not be prescribed to patients who are not diabetic (Circular 045/CD/100.20.200). In September 2025 INFARMED relayed the EMA and HMA warning of a sharp increase in the illegal marketing of medicines presented as GLP-1 receptor agonists, and stated that in Portugal medicines can only be bought on the internet from the websites of pharmacies and licensed non-prescription medicine outlets (LVMNSRM). <sub>(pt-infomed · pt-infomed-guide · pt-infarmed-circ045-2024 · pt-infarmed-glp1-illegal-2025)</sub>
- *BR:* In Brazil, as of September 2026, Ozempic is indicated for adults with insufficiently controlled type 2 diabetes mellitus, Wegovy is indicated for weight management in adults, Mounjaro is indicated for chronic weight management in adults, and the approved synthetic semaglutide copies are indicated for adult patients with insufficiently controlled type 2 diabetes mellitus. Nota Técnica 200/2025 (August 2025) permits compounding of chemically synthesised APIs provided registered medicines with the same molecule already exist in Brazil, and ANVISA inspections from January to April 2026 led to the closure of 8 of the 26 establishments assessed and the seizure of more than 1.3 million units of irregular injectable medicines. <sub>(br-label-ozempic · br-anvisa-register-opendata · br-label-wegovy · br-label-mounjaro · br-anvisa-consultas-medicamentos · br-anvisa-semaglutide-synthetic-2026 · br-anvisa-semaglutide-five-2026 · br-anvisa-glp1-compounding-2025 · br-anvisa-nt200-2025 · br-anvisa-pf-2026 · br-anvisa-glp1-actionplan-2026)</sub>
- *AE:* In the UAE, the Emirates Drug Establishment (EDE) announced on 1 June 2026 that it had approved oral Wegovy (semaglutide) for long-term weight management in adults with obesity, or overweight with weight-related conditions, and a Ministry of Health and Prevention alert (Circular 9217/2024, October 2024) described genuine Mounjaro as registered for type 2 diabetes and weight management. Federal Decree-Law 38/2024 bars compounding pharmacies from compounding essential copies of products that hold an EDE marketing approval unless no commercially available product can deliver the expected benefit to the patient. On 20 July 2026 the EDE warned that 1,659 packs of Mounjaro and Ozempic missing from a warehouse are outside the legitimate supply chain and told the public to buy these medicines only from licensed pharmacies. <sub>(ae-ede-news-oral-wegovy · ae-mohap-cir-9217-2024 · ae-fdl-38-2024 · ae-ede-cir-31-2026)</sub>
...
**14.9% · 20.9%** — mean weight loss in STEP-1 (semaglutide, 68 weeks) and SURMOUNT-1 (tirzepatide, highest dose, 72 weeks) (Placebo 2.4% and 3.1% · both trials industry-funded, both the basis for approval)  
*Means:* These drugs produce large, reproducible weight loss in randomized trials: GRADE A for the approved indications. Part of what is lost is lean tissue, which is why the Hormonaly guide pairs treatment with protein and resistance training.  
*Does not mean:* Neither pivotal trial measured facial fat, skin laxity or appearance. An A for weight loss says nothing about the face.
...
**Regulatory status by jurisdiction**
- *GB:* UK product information also lists hair loss: 2.5% on Wegovy and 4.9% on Mounjaro in the weight-management trials, against 1.0% on placebo. <sub>(Novo Nordisk A/S (marketing authorisation holder) 2026 · Eli Lilly Nederland B.V. (marketing authorisation holder) 2026)</sub>
...
- Before: set expectations about face and hair
- During: photographs with consent, protect lean mass
- When asked: refer for restoration

**By role**
- *Prescriber:* Put facial volume change and hair shedding into the consent conversation before you start, and document it. At follow-up, review nutrition, strength training and consented photographs. Keep the indication in view, and refer restoration requests rather than improvising them.
- *Clinical staff:* Record the patient's concern, the medicine and who prescribes it, and consented photographs. Do not suggest pausing or changing the medicine; bring the concern to the prescriber and pass restoration questions to the aesthetic lead.
- *Advisor:* Explain that facial change tracks the weight lost and that hair loss is a listed side effect. Questions about the dose or about stopping belong with the prescriber; restoration questions belong with a qualified aesthetic clinician.

<details><summary>Narration script</summary>

Three moments matter in practice. Before treatment starts, raise facial volume change and hair shedding as possibilities, especially with older patients, as the Hormonaly guide advises, and record that you did. During treatment, photograph the face with consent so that change is measured rather than remembered, and support the protein intake and resistance training the guide recommends to protect lean mass. When a patient asks for help with the face, refer to a qualified aesthetic or dermatology colleague. The published advice on restoring volume after drug-driven weight loss is expert opinion, the main consensus statement was developed with industry involvement, and randomized trials of fillers and devices in these patients are registered with no results yet. Whatever your role, decisions about the medicine itself stay with the prescriber and the patient.
...
- Facial volume loss tracks the weight lost
- Hair loss is a labelled side effect, more common in women
- The indication is responding; the medicine decision is the prescriber's

**Exercise (scenario) · What do you do first?** — 

A 58-year-old patient has taken semaglutide for obesity for ten months, prescribed by her physician, and has lost 18% of her body weight. Her blood pressure and glucose have improved. She is distressed by hollow cheeks, new laxity along the jaw and more hair in her brush, and asks whether she should stop the injections.

- ✗ Tell her to stop the injections; her face matters more than the scale. — *That is a medication decision made on one side effect, outside her prescriber's care, and it sets aside an indication that is working.*
- ✔ Acknowledge the change, explain that it follows the weight lost, record it with consented photographs, and take the stop-or-continue question to her prescriber, with a referral for restoration if she wants one. — *Right. Counsel, record, refer. The medicine decision stays with her prescriber, and restoration goes to someone qualified to provide it.*
- ✗ Reassure her that her face will fill out again once her weight settles. — *That promise has no evidence behind it; no study found for this course followed facial volume after the weight loss stopped.*

Follow-up: Then document the conversation: her concerns, what you explained, and who she will see next.

**By role**
- *Prescriber:* You own the medication conversation: review her progress against the indication, her nutrition, strength training and hair, and refer for restoration if she wants it. Document the discussion.
- *Clinical staff:* You record the concern, consented photographs and the hair change, and bring it to the prescriber this week. You do not advise on the dose or on stopping.
- *Advisor:* You explain what is known, suggest she talk to her prescriber before changing anything, and point her to a qualified aesthetic clinician for restoration questions.

<details><summary>Narration script</summary>

Picture a fifty-eight-year-old patient, fictional and built from this lesson's evidence. She has taken semaglutide for obesity for ten months, prescribed by her physician, and has lost eighteen percent of her body weight. Her blood pressure and glucose have improved. She is distressed by hollow cheeks and new looseness along the jaw, and she is finding more hair in her brush. She asks whether she should stop the injections. Consider what the evidence says. In the studies so far, facial volume loss tracks the amount of weight lost. Hair loss is a labelled side effect, reported more often in women and linked to weight reduction. The drug was prescribed for a medical reason, and that reason is going well. Decide how you would answer her.
...
**Q.** Which statement about facial change on semaglutide or tirzepatide matches the evidence as of September 2026?
- ✗ Randomized trials show these drugs age facial skin directly. — *No randomized trial has measured the face, and a direct effect on skin is a hypothesis from cell studies.*
- ✔ Facial volume loss is reported in small observational studies and tracks the amount of weight lost; no randomized trial has measured it. — *Correct. Observational, small, and consistent with weight loss as the driver.*
- ✗ Facial volume loss is a labelled adverse reaction in the US prescribing information. — *Hair loss is labelled. Facial volume loss is not.*
...
- Gut to skin in people: not shown
...
**39 RCTs** — in the Cochrane review of oral probiotics for treating eczema (2,599 participants · little or no difference in patient-rated symptoms (moderate-certainty evidence))  
*Means:* The most direct test of 'treat the gut, help the skin' in a common inflammatory skin disease shows, at most, a small effect. GRADE B for little or no benefit a patient would notice.  
*Does not mean:* It does not rule out benefit from particular strains or in particular groups, and it says nothing about skin ageing. Newer pooled analyses in children report small improvements.
...
| | | |
|---|---|---|
| Probiotic capsules | Sold to calm eczema | Supplement |
| Rifaximin for rosacea with bacterial overgrowth | Used to clear rosacea | Prescription antibiotic |
| Tirzepatide added to a psoriasis biologic | Proposed to clear psoriasis and reduce weight | Prescription drug |
| A high-fibre, plant-rich diet | Said to improve skin through the gut | Diet |
| Akkermansia capsules | Sold to strengthen the gut barrier | Next-generation probiotic |
| A 'leaky gut' stack: L-glutamine, zinc carnosine, BPC-157 | Sold to seal the gut and clear the skin | Supplements and a research peptide |

**Callout:** Ask which product, which outcome and which trial.
...
**Regulatory status by jurisdiction**
- *EU:* In the EU, tirzepatide is authorised as Mounjaro (EU-wide, 15 September 2022) for adult weight management, prescription-only. A search of the Union Register and EMA's data on authorised, refused and withdrawn medicines on 25 September 2026 found no centrally authorised medicine containing BPC-157. <sub>(eu-ema-epar-mounjaro · eu-union-register · eu-ema-medicines-data)</sub>
- *BR:* In Brazil, Mounjaro (tirzepatide), registered by ANVISA since 25 September 2023, is indicated as an adjunct to a low-calorie diet and increased physical activity for chronic weight management in adults. ANVISA stated on 2 July 2026 that BPC-157 is not authorised for use as a food supplement and that no company applications or studies have been submitted to regularise it as a food supplement. <sub>(br-label-mounjaro · br-anvisa-consultas-medicamentos · br-anvisa-peptides-2026)</sub>
- *AE:* In the UAE, a search of the Emirates Drug Establishment (EDE) register on 25 September 2026 found no registered product containing BPC-157, and a Ministry of Health and Prevention alert (Circular 9217/2024) described genuine Mounjaro (tirzepatide) as registered for type 2 diabetes and weight management. In Dubai, the DHA prohibits prescribing, dispensing, administering or using any peptide product unless it is registered or licensed with the EDE and used within the scope of its licence (29 July 2026). In Abu Dhabi, the DoH treats peptides as high-risk substances that may be compounded only if monographed, part of an approved medicine or listed by the DoH for compounding (August 2026). <sub>(ae-ede-register · ae-mohap-cir-9217-2024 · ae-dha-cir-peptides-2026 · ae-doh-compounding-std-2026)</sub>
...
**Q.** A patient asks for a zonulin blood test to prove that her rosacea comes from a leaky gut. What is the most accurate reply?
- ✗ The test will show whether her gut barrier is causing the rosacea. — *A widely used zonulin assay detects other proteins, and a zonulin result cannot tell you what is causing her rosacea.*
...
**Exercise (chips) · Your checklist** — Tap everything you will do. Choose as many as you like.
*Before my next conversation about weight, skin and the gut I will …* set expectations about face and hair before treatment starts · record facial concerns with consented photographs · ask whether a benefit was shown in mice, in people or only on a label · treat a surrogate reading as a surrogate · refer restoration requests to a qualified colleague · leave decisions about the medicine to the prescriber

**By role**
- *Prescriber:* Your checklist ends with documentation: expectations set before treatment, concerns recorded, referrals made.
- *Clinical staff:* Your checklist ends with escalation: questions about the medicine go to the prescriber the same week.
- *Advisor:* Your checklist ends with referral: product questions you can answer; medicine and restoration questions go to a prescriber or a qualified aesthetic clinician.

<sub>Sources: Aesthetic & Regenerative Endocrinology — A Clinician's Pocket Guide 2026 · Nikolis A 2025</sub>


## Module check

**Q.** Closing Module 3: which statement keeps the four registers apart?
- ✗ Semaglutide ages the face by acting on facial fat, so the label should carry a facial warning. — *That blends an untested hypothesis with a regulatory conclusion. The labels list hair loss; a direct action on facial fat is untested in people.*
- ✔ Facial volume loss on incretins: fat loss deflates facial compartments (mechanism); small observational studies tie it to the amount of weight lost (human evidence); US labels list hair loss but not facial change (regulatory status); whether the drugs act directly on facial fat is untested (open question). — *Correct. Four separate answers, each with its own source.*
- ✗ Weight loss on these drugs is GRADE A, so their facial effects are GRADE A too. — *A grade belongs to an outcome. The pivotal trials never measured the face.*
...
## Lesson 4.1 · Copper peptides: GHK and GHK-Cu

### 01 / 19 · The peptide your patient already bought.  
*Module 04 · Matrix peptides and wound healing · title*

Most skin peptides reach your clinic before any evidence does. In three lessons you will sort them by what the human trials actually show, who paid for those trials, and where each one stands with the regulator.
...
The evidence and grades are the same for everyone, and regulatory notes follow the country you choose. What changes with your role is the 'what you do next' at the end of each lesson, so it fits what your licence lets you do.

*Choose the one closest to your role*
- **I prescribe: physician, NP or PA** → Your path closes each lesson on the prescribing decision: status checks, consent, documentation and when to refer.
- **I deliver treatments: RN, aesthetic nurse or injector** → Your path closes each lesson on what you notice, what you record and when you escalate to the prescriber.
- **I advise on products: pharmacist, ND or allied professional** → Your path closes each lesson on what you can accurately say about a product and when a patient needs a prescriber.

### 03 / 19 · A plasma tripeptide with a copper habit.  
*Mechanism · audio*

GHK is a tripeptide found in human plasma, first described in 1973. Bound to copper it becomes GHK-Cu, which is proposed to deliver copper to enzymes such as superoxide dismutase and lysyl oxidase and to switch on wound-healing and antioxidant gene programmes. Most of that mechanistic literature comes from the group that discovered the peptide.

- Endogenous: GHK circulates in human plasma
- Proposed: copper delivery to matrix and antioxidant enzymes
- Mechanism register only — written largely by the originator

<details><summary>Narration script</summary>

Start with the molecule. GHK is a three-amino-acid peptide that circulates in human plasma; it was first described in 1973. It binds copper readily, and the copper complex, GHK-Cu, is what skin-care labels mean when they say copper peptide. The proposed mechanism is that GHK-Cu delivers copper to enzymes that build and protect the dermal matrix, such as lysyl oxidase and superoxide dismutase, and shifts gene expression toward wound healing. Two things to hold on to. First, this is a mechanism, which explains why the peptide might work and leaves open whether it does. Second, most of this literature was written by the group that discovered the peptide. Keep both in mind when you reach the trials.
...
Every peptide question has four separate answers. For GHK-Cu they point in different directions, which is exactly why they must not be blended into one sentence.
...
**Regulatory status by jurisdiction**
- *GB:* In the UK, a GHK-Cu serum sold for appearance is a cosmetic, and cosmetics law excludes anything injected (September 2026). <sub>(Cosmetic Products Regulation 1223/2009 (Great Britain 2009 · Medicines and Healthcare products Regulatory Agency (UK) 2025)</sub>
- *EU:* In the EU, copper tripeptide-1 is listed in the Commission's CosIng inventory with a skin-conditioning function (read 25 September 2026). No centrally authorised medicine containing GHK-Cu was found in the Union Register or in EMA's data on authorised, refused and withdrawn medicines (searched 25 September 2026). <sub>(eu-cosing-copper-tripeptide-1 · eu-cosing-home · eu-ema-medicines-data · eu-union-register)</sub>
- *PT:* In Portugal, no medicine containing GHK-Cu is listed in INFARMED's Infomed register, which includes authorised, lapsed and revoked products (searched 25 September 2026). <sub>(pt-infomed)</sub>
- *BR:* In Brazil, ANVISA stated on 2 July 2026 that products presented as peptides called GHK-Cu that promise aesthetic effects or improvement in health conditions are not registered with Anvisa. <sub>(br-anvisa-peptides-2026)</sub>
- *AE:* In the UAE, the Emirates Drug Establishment (EDE) has held medicines registration since Federal Decree-Law 28/2023, and no registered medical product matching GHK, prezatide, copper tripeptide or copper peptide was found in the EDE register (25 September 2026). In Dubai, the DHA's rules for health facilities prohibit circulating, prescribing, dispensing, administering or using any peptide product unless it is registered or licensed with the EDE (29 July 2026); in Abu Dhabi, the DoH classes topical cosmetic peptides with no systemic effect as low-risk products that stay under existing regulatory pathways, while systemic, regenerative or weakly evidenced peptides face enhanced controls (31 July 2026). <sub>(ae-fdl-28-2023 · ae-ede-register · ae-dha-cir-peptides-2026 · ae-doh-cir-148-2026)</sub>
...
**By role**
- *Prescriber:* In the US, before prescribing a compounded topical, confirm the substance's current 503A status and that the pharmacy is working within it. Do not prescribe GHK-Cu for injection. Record that you discussed a product with small-trial evidence and the patient's reasons for choosing it.
...
**Regulatory status by jurisdiction**
- *GB:* In the UK, anything injected falls outside cosmetics law, and MHRA decides whether it is a medicine from its claims, form and use. In the UK, a GHK-Cu serum presented for appearance is a cosmetic, so there is nothing to prescribe. <sub>(Cosmetic Products Regulation 1223/2009 (Great Britain 2009 · Medicines and Healthcare products Regulatory Agency (UK) 2025)</sub>
- *EU:* In the EU, a substance or mixture intended to be injected is not considered a cosmetic product (Regulation (EC) No 1223/2009, Article 2(2)); the EU borderline manual adds that a product in a vial or ampoule for use by injection cannot be considered a cosmetic product, and should not be marketed with a device that could allow injection or delivery below the epidermis. Whether a product qualifies as a cosmetic is decided case by case by national competent authorities, and the manual says an anti-wrinkle product that significantly restores, corrects or modifies physiological functions by exerting a pharmacological, immunological or metabolic action does not qualify as one (version 5.5, June 2025). <sub>(eu-reg-1223-2009 · eu-ec-cosmetics-borderline-manual-2025 · eu-reg-1223-2009-oj)</sub>
- *PT:* In Portugal, INFARMED states that products administered by injection are not considered cosmetics (as of 25 September 2026), and medicines intended for parenteral administration are subject to medical prescription by law (Estatuto do Medicamento, Art 114(1)(d)). <sub>(pt-infarmed-cosmetics-faq · pt-dl176-2006)</sub>
- *BR:* In Brazil, ANVISA stated on 2 July 2026 that injectable cosmetics do not exist; an injectable product offered as a cosmetic is irregular. Products with 'GHK' in the product name appear as notified cosmetics in ANVISA's public cosmetics data (221 entries, 25 September 2026), and ANVISA cancelled several GHK-Cu cosmetic processes on 29 April 2026 without published reasons (RE 1.771/2026). <sub>(br-anvisa-peptides-2026 · br-anvisa-cosmetics-opendata · br-dou-re-1771-2026)</sub>
- *AE:* In the UAE, the medicines law (Federal Decree-Law 38 of 2024) defines cosmetics as products with a medical effect on the skin, hair or nails, and whether a product requires an Emirates Drug Establishment (EDE) marketing authorisation, and in which category, is determined by an EDE classification letter based on its presentation, composition, use and design. In Dubai, peptide products may be prescribed, dispensed or administered only by licensed, authorised professionals in a licensed health facility (DHA, 29 July 2026); in Abu Dhabi, physicians may prescribe peptide therapies only for clinical indications supported by available scientific evidence, after a documented eligibility assessment and with informed consent that covers benefits, uncertainties, risks, alternatives and the product's regulatory approval status (DoH, 31 July 2026). <sub>(ae-fdl-38-2024 · ae-ede-svc-classification · ae-dha-cir-peptides-2026 · ae-doh-cir-148-2026)</sub>
...
One question to close lesson 4.1.

**Q.** A patient asks whether GHK-Cu injections are 'stronger' than the serum she uses. What does the evidence support?
- ✗ Yes — injection bypasses the skin barrier, so it must work better. — *That is a mechanism argument. There are no randomized trials of injected GHK-Cu, so 'works better' has no evidence behind it.*
- ✔ The topical form has small-trial support; injection rests on anecdote, commonly irritates, and in the US sits outside the Category 1 listing. — *Correct. Same molecule, different route, different evidence and different regulatory standing.*
- ✗ They are equivalent, because it is the same molecule. — *The molecule is the same; the route changes the evidence, the side-effects and the regulatory status.*


## Lesson 4.2 · Signal peptides, oral collagen and SNAP-25 mimics
...
- Oral collagen: the supplement aisle

<details><summary>Narration script</summary>

Lesson two covers three families that fill the cosmetic and supplement shelves. Signal peptides, like palmitoyl pentapeptide-4, sold as Matrixyl, are fragments of matrix proteins meant to tell fibroblasts to make more collagen. SNAP-25 mimics, Argireline and its longer cousin SNAP-8, copy part of a nerve-terminal protein that botulinum toxin targets; the idea is a gentle, topical version of that effect. And oral collagen peptides are swallowed, not applied. Every one of these has trials behind it. As you go through them, keep asking one question before any other: who ran the trial, and who paid for it.

</details>

<sub>Sources: Lupo MP 2007 · Lintner K 2000 · Blanes-Mira C 2002 · Errante F 2020 · Aesthetic & Regenerative Endocrinology — A Clinician's Pocket Guide 2026 · Schagen SK 2017</sub>

### 09 / 19 · A trial, or a brochure?  
*Sort the evidence · tool*

Five products from two families, and what each promises on the label. Before you see a grade, decide what actually stands behind each one.

| | | |
|---|---|---|
| pal-KTTKS (Matrixyl) | Firmer skin, fewer wrinkles | Signal peptide |
| Matrixyl 3000 blend | Firmer skin, fewer wrinkles | Signal-peptide blend |
| Argireline | Softer expression lines | SNAP-25 mimic, six residues |
| SNAP-8 | Softer expression lines | SNAP-25 mimic, eight residues |
| Leuphasyl | Softer lines, paired with Argireline | Enkephalin analogue |

**Callout:** 'Clinically tested' can mean a randomized trial or a brochure. Ask which.
...
Pooled, oral collagen trials show better hydration, elasticity and wrinkle scores, and the Aesthetic & Regenerative Endocrinology guide grades them C. A 2025 meta-analysis split the same kind of trials by funding and by quality. The benefit appeared only in pharmaceutical-funded and low-quality trials. Unfunded and high-quality trials showed no effect.

**23 RCTs** — in the 2025 meta-analysis that split oral-collagen trials by funding and quality (1,474 participants)  
*Means:* The pooled benefit of oral collagen disappears when you look only at independent or high-quality trials. The course keeps the guide's GRADE C and shows why a downgrade has been proposed to its author.  
*Does not mean:* It does not show collagen is harmful, and it does not rule out benefit for an individual. It is a statement about the evidence, and it says nothing about topical peptides.

<sub>Sources: Myung SK 2025 · Pu SY 2023 · de Miranda RB 2021 · Kim DU 2018 · Aesthetic & Regenerative Endocrinology — A Clinician's Pocket Guide 2026</sub>
...
- Say 'modest, small-trial' — never 'topical Botox'

**By role**
- *Prescriber:* Nothing here needs a prescription. If you recommend a product, recommend it on evidence, name the grade, and disclose any relationship with the brand. The 'topical Botox' claim is not one to repeat.
- *Clinical staff:* When a patient asks which serum 'really works', the accurate answer is modest effects from mostly sponsor-funded trials. Do not describe any of them as an alternative to botulinum toxin.
- *Advisor:* The claim you can stand behind is modest, small-trial evidence. Supplements cannot be sold as treating a disease; if a patient expects collagen to fix a skin condition, that is a conversation for a prescriber.

**Regulatory status by jurisdiction**
- *GB:* In the UK, a peptide serum is a cosmetic: its responsible person needs a safety assessment and must notify the regulator before sale, and must be able to prove its claims. Oral collagen is a food supplement: no food may claim to prevent, treat or cure disease, and only authorised health claims may be used. In May 2026 the UK advertising regulator ruled a peptide serum's 'clinically proven' lifting claim misleading because the study behind it was small and uncontrolled. <sub>(Cosmetic Products Regulation 1223/2009 (Great Britain 2009 · Cosmetic Products Regulation 1223/2009 (Great Britain 2009 · Office for Product Safety and Standards / Department for Business and Trade 2021 · Food Supplements (England) Regulations 2003 2003 · Food Information to Consumers Regulation 1169/2011 (UK 2011 · Nutrition and Health Claims Regulation 1924/2006 (UK 2006 · Medicines and Healthcare products Regulatory Agency (UK) 2025 · Advertising Standards Authority 2026)</sub>
- *EU:* In the EU, a peptide serum sold as a cosmetic needs a responsible person in the EU, a safety assessment with a product safety report and electronic notification to the Commission before it is placed on the market (Regulation (EC) No 1223/2009), and its claims must be supported by adequate and verifiable evidence (Regulation (EU) No 655/2013). Food labelling and advertising may not claim that a food prevents, treats or cures a disease, and health claims on foods are prohibited unless authorised: the Commission refused a claim that a collagen peptide mixture maintains skin health by increasing elasticity and reducing wrinkles, because cause and effect was not established (Regulation (EU) No 1154/2014), and the EU Register lists no authorised claim for collagen itself (searched 25 September 2026). <sub>(eu-reg-1223-2009 · eu-reg-655-2013 · eu-reg-1169-2011 · eu-reg-1924-2006 · eu-reg-1154-2014 · eu-claims-register)</sub>
- *PT:* In Portugal, INFARMED is the competent authority for cosmetics (Decreto-Lei 23/2025), and borderline products must be assessed case by case by the Responsible Person, taking all their characteristics into account (INFARMED, as of 25 September 2026). For food supplement notification, there is no evaluation of the product or validation of labelling; control is carried out afterwards by sampling and may take place at any time (DGAV, as of 25 September 2026). <sub>(pt-dl23-2025 · pt-infarmed-cosmetics-faq · pt-dgav-notification · pt-dgav-supplements)</sub>
- *BR:* In Brazil, cosmetic labelling must not contain trade names, brands, images, electronic links or wording that represent therapeutic claims attributed to the use of the product or its ingredients (RDC 907/2024, art. 12). Under ANVISA's January 2025 food supplement guidance, an approved claim is that bioactive hydrolysed collagen peptides with an average molecular weight of 2 kDa help maintain skin health. <sub>(br-rdc-907-2024 · br-anvisa-supplements-ingredients · br-anvisa-supplements-qa-2025 · br-rdc-243-2018)</sub>
- *AE:* In the UAE, the medicines law (Federal Decree-Law 38 of 2024) treats food supplements, oral products that support the diet and do not treat, diagnose or prevent disease, as medical products regulated by the Emirates Drug Establishment (EDE): oral collagen products are registered with the EDE as general-sale-list health products rather than medicines, while ordinary cosmetics need a conformity certificate from the Ministry of Industry and Advanced Technology under Cabinet Resolution 18/2014. Advertising any medical product, social media included, requires EDE approval. In Dubai, the DHA's rules for health facilities ban misleading or unproven peptide claims, such as anti-ageing, cell regeneration or improved appearance, unless the use is within the product's approved status (29 July 2026); in Abu Dhabi, the DoH bars healthcare providers from promoting peptide therapies with misleading or unsubstantiated claims, or advertising them without prior approval from the DoH and relevant authorities (31 July 2026). <sub>(ae-fdl-38-2024 · ae-ede-svc-healthcare-product · ae-ede-reg-collafix · ae-ede-reg-centrum-shn · ae-ede-register · ae-moiat-regulated-products · ae-moiat-ecas-service · ae-dha-cir-peptides-2026 · ae-doh-cir-148-2026)</sub>

<details><summary>Narration script</summary>

Now the regulatory register, stated for the United States. Cosmetic peptides are cosmetic ingredients, not drugs; their safety is assessed under a cosmetics framework, and nobody has to prove they work before they are sold. Oral collagen is sold as a dietary supplement, so it cannot claim to treat a disease, and what is in the tub varies from brand to brand. That is the whole reason the funding question matters here. When no regulator asks for efficacy, the only efficacy data are the trials someone chose to pay for.
...
One question to close lesson 4.2.

**Q.** A patient shows you a collagen drink labelled 'clinically proven to reduce wrinkles'. What is the most accurate reply?
- ✔ The trials are real, but the benefit shows up only in industry-funded and lower-quality trials; independent, high-quality trials show no effect. — *Correct. That is what the 2025 funding-stratified meta-analysis found.*
- ✗ Meta-analyses prove that collagen improves skin. — *Pooled, yes. Split by funding and quality, the effect disappears in the independent and high-quality trials.*
- ✗ Collagen is digested, so it cannot do anything. — *That is a mechanism argument. The course rests on the trials, and the problem with the trials is who ran them.*


## Lesson 4.3 · Repair peptides and the compounding line

### 13 / 19 · Rodents, a fragment, and a tripeptide.  
*Lesson 4.3 · Concept · audio*

BPC-157 rests on a large rodent literature, mostly from one research group, and on uncontrolled human case series. TB-500 is not thymosin β4: it is a seven-residue fragment of it, identified by analysing the product itself, and no trial has tested the fragment. KPV, a tripeptide from the end of α-MSH, calms inflammation in mouse colitis and has no randomized human trial.

- BPC-157: rodents and case series
- TB-500: a fragment, never trialled
- KPV: mouse colitis only

<details><summary>Narration script</summary>

Lesson three moves from the cosmetic shelf to the peptides patients buy online and inject. BPC-157 is a fifteen-residue peptide first described in 1993. Its evidence is a large rodent literature, most of it from one research group, and uncontrolled human case series. TB-500 is sold as thymosin, but when anti-doping chemists analysed the product they found a seven-residue fragment, residues seventeen to twenty-three of thymosin beta-four. That fragment has never been tested in a trial. KPV is the last three amino acids of alpha-MSH; it calms inflammation in mouse colitis models, and there is no randomized human trial of it for anything. All three have plausible mechanisms, and none has a controlled human trial.
...
LL-37, the skin's own cathelicidin, is the one repair peptide with two randomized trials in hard-to-heal venous leg ulcers. Read them in order.

| | | |
|---|---|---|
| First trial (2014) | Positive at low dose | First-in-human, randomized, dose-ranging; 34 patients |
| Second trial (2021) | Negative in the full cohort | Multicentre phase IIb, placebo-controlled; only a post hoc subgroup signal |
| Who ran them | The developer, both times | Sponsorship does not make a trial wrong; it is one more reason to wait for replication |
| Grade | C — inconsistent | A small positive trial followed by an adequately powered negative one |

**Callout:** A small positive trial is a hypothesis. LL-37 is what happens when someone tests it.

<sub>Sources: Grönberg A 2014 · Mahlapuu M 2021 · Schauber J 2008 · The Peptide Pocket Guide — 2026 Edition · Clinical Reference (seventy-two entries) 2026</sub>
...
| | | |
|---|---|---|
| Cosmetic or supplement | Not a drug | No efficacy approval before sale; supplements may not claim to treat disease |
| 503A Category 1 | Under FDA evaluation | FDA does not intend to act against compounders who meet its conditions while it evaluates |
| Not on the 503A bulks list | No 503A exemption | Compounded products do not qualify; an advisory-committee review is not approval |

**Callout:** Review is not approval. Check the live list before any conversation about compounding.

**Exercise (quickfire) · Where does it stand?** — One product at a time: which US category is it in today?
- An Argireline serum → **Cosmetic or supplement** — *A cosmetic ingredient, not a drug.*
- An oral collagen drink → **Cosmetic or supplement** — *A dietary supplement: no disease claims, no efficacy approval.*
- Compounded topical GHK-Cu → **Category 1: under evaluation** — *Non-injectable GHK-Cu is in 503A Category 1 (FDA list of 14 May 2026), pending an advisory-committee consultation before the end of February 2027.*
- GHK-Cu for injection → **Not on the bulks list** — *The Category 1 entry excludes injectable routes.*
...
**Regulatory status by jurisdiction**
- *GB:* If you practise in the UK, the route for unlicensed medicines works differently, and lesson 7.2 sets it out. <sub>(Medicines and Healthcare products Regulatory Agency (UK) 2023)</sub>
- *EU:* In the EU, a medicine prepared in a pharmacy on prescription for an individual patient (magistral formula), or to a pharmacopoeia for the pharmacy's own patients (officinal formula), falls outside Directive 2001/83/EC and needs no marketing authorisation under it (Article 3), and each member state may, under its own law, allow an unauthorised medicine for an individual patient on a professional's bona fide unsolicited order, under that professional's direct personal responsibility (Article 5(1)). No centrally authorised medicine containing GHK-Cu, BPC-157 or TB-500 was found in the Union Register or in EMA's data on authorised, refused and withdrawn medicines (searched 25 September 2026). <sub>(eu-dir-2001-83 · eu-ema-medicines-data · eu-union-register)</sub>
- *PT:* In Portugal, a magistral formula is a medicine prepared in a community or hospital pharmacy, under a pharmacist's responsibility, on a medical prescription that names the patient, and the prescribing physician must satisfy themselves of its safety and efficacy (Decreto-Lei 95/2004). Compounded medicines may use only raw materials listed in the Portuguese pharmacopoeia, the European pharmacopoeia or another European pharmacopoeia, or in compendial scientific documentation, and one containing any other raw material may not be prescribed. <sub>(pt-dl95-2004 · pt-infarmed-manipulados)</sub>
- *BR:* In Brazil, ANVISA stated on 2 July 2026 that any substance must have passed efficacy and safety assessment before it can be compounded, and that compounding may only be individual, on presentation of a medical prescription, by a compounding pharmacy licensed by local health surveillance. The same notice says BPC-157 and TB-500 are not authorised as food supplements, and that products presented as peptides called GHK-CU, BPC-157, and TB-500 promising aesthetic effects or health improvements are not registered with ANVISA. <sub>(br-anvisa-peptides-2026)</sub>
- *AE:* In the UAE, the medicines law (Federal Decree-Law 38 of 2024, in force 2 January 2025) exempts medical products compounded in licensed compounding pharmacies from the requirement for a marketing approval from the Emirates Drug Establishment (EDE). In Dubai, the DHA's rules for health facilities prohibit circulating, prescribing, dispensing, administering or using any peptide product unless it is registered or licensed with the EDE (29 July 2026); in Abu Dhabi, the DoH treats peptides as emerging, non-monographed, high-risk substances, and novel substances of unknown risk may be compounded only if monographed, a component of an approved medicine or listed on the DoH's register of compounded substances (compounding standard, August 2026). <sub>(ae-fdl-38-2024 · ae-dha-cir-peptides-2026 · ae-doh-compounding-std-2026)</sub>
...
A 46-year-old patient has been injecting a research-use-only 'GLOW' blend bought online for three months. She reports smoother skin and asks about continuing. You notice new, patchy darkening on her face and forearms. This is a fictional case built from the lesson's evidence; there is one right first move.

- GLOW = GHK-Cu, BPC-157 and TB-500; no controlled human trials
- Research-use-only products are made outside GMP
- New pigmentation on these products is a red flag
...
**By role**
- *Prescriber:* You assess the pigmentation or refer to dermatology, consider whether investigation is needed, and document the investigational product and your advice.
- *Clinical staff:* You record the product, source and batch, photograph with consent if your setting allows, and escalate to the prescriber the same day.
- *Advisor:* You advise her to stop, keep the vial and packaging, and see a prescriber promptly; you do not suggest an alternative supplier.

**Regulatory status by jurisdiction**
- *EU:* In the EU, a product presented as treating or preventing disease, or used to restore, correct or modify physiological functions by a pharmacological, immunological or metabolic action, is a medicine, and where a product could be both a medicine and another regulated product, medicines law applies (Directive 2001/83/EC, Articles 1(2) and 2(2)). No medicine may be placed on a member state's market without a national or EU-wide marketing authorisation (Article 6(1)), and the directive's exclusion for research concerns medicinal products intended for research and development trials (Article 3(3)). <sub>(eu-dir-2001-83)</sub>
- *PT:* In Portugal, a medicine is defined as any substance or combination of substances presented as having properties for treating or preventing disease or used in or administered to human beings to restore, correct or modify physiological functions by exerting a pharmacological, immunological or metabolic action, and making, selling, supplying or administering a medicine without the required authorisation is an administrative offence (Estatuto do Medicamento, Arts 3 and 181). No medicine containing GHK-Cu, BPC-157 or TB-500 is listed in INFARMED's Infomed register, which includes authorised, lapsed and revoked products (searched 25 September 2026), and INFARMED does not authorise the import of medicines for personal use (Circular 148/CD, 29 July 2011). <sub>(pt-dl176-2006 · pt-infomed · pt-infarmed-circ148-2011)</sub>
- *BR:* In Brazil, ANVISA stated on 2 July 2026 that products presented as peptides called BPC-157, TB-500 and GHK-Cu are not registered, and that some injectable peptides not regularised in any category (food, medicine, cosmetic or food supplement) are illegal for any health use, including aesthetic use. ANVISA also stated in July 2026 that an investigational medicine is used exclusively in authorised clinical research. <sub>(br-anvisa-peptides-2026 · br-anvisa-medicine-types-2026)</sub>
- *AE:* In the UAE, the medicines law (Federal Decree-Law 38 of 2024) has, since 2 January 2025, barred importing, distributing, possessing, selling, using or manufacturing any medical product for circulation without a marketing approval from the Emirates Drug Establishment (EDE), and no registered medical product matching GHK-Cu, BPC-157 or TB-500 was found in the EDE register (25 September 2026). In Dubai, the DHA's rules for health facilities prohibit using any peptide product intended for research use on humans, or for therapeutic purposes, outside a study or clinical trial approved by the competent authority, and bar buying, accepting or using peptide products from websites, social media, individual accounts or unlicensed or unverifiable suppliers (29 July 2026). In Abu Dhabi, the DoH requires compounded peptide formulations to use only certified active ingredients imported under EDE oversight, with peptide products traceable from source to patient (31 July 2026). <sub>(ae-fdl-38-2024 · ae-ede-register · ae-dha-cir-peptides-2026 · ae-doh-cir-148-2026)</sub>
...
<sub>Sources: Aesthetic & Regenerative Endocrinology — A Clinician's Pocket Guide 2026 · The Peptide Pocket Guide — 2026 Edition · Clinical Reference (seventy-two entries) 2026 · Vanhee C 2020 · Ashraf AR 2024 · US Food and Drug Administration 2026 · US Food and Drug Administration 2026</sub>

### 18 / 19 · After the July review.  
*Your turn · quiz*

One question to close lesson 4.3.

**Q.** FDA's Pharmacy Compounding Advisory Committee reviewed BPC-157, KPV and TB-500 in July 2026. What does that change for 503A compounding today?
- ✗ They can now be compounded, because the committee reviewed them. — *The committee advises; nothing changes until FDA adds a substance to the bulks list by rulemaking.*
- ✔ Nothing yet: the committee advises, FDA must still act by rulemaking, and until then compounded products do not qualify for the 503A exemptions. — *Correct. Review is not approval.*
- ✗ Only the injectable forms are restricted now. — *None of the three is on the bulks list in any form; the injectable-only exception applies to GHK-Cu's Category 1 entry, not to these.*

### 19 / 19 · Before my next peptide conversation.  
*Closing and commitment · action*
...
- *Clinical staff:* Your checklist ends with escalation: anything injected or research-use-only goes to the prescriber the same day.
- *Advisor:* Your checklist ends with referral: product questions you can answer; treatment questions go to a prescriber.

<sub>Sources: Aesthetic & Regenerative Endocrinology — A Clinician's Pocket Guide 2026 · US Food and Drug Administration 2026</sub>


## Module check

**Q.** Closing Module 4: which statement keeps the four registers apart?
- ✗ GHK-Cu has a strong mechanism, so its evidence grade is high. — *That blends mechanism into human evidence. The mechanism is plausible; the human evidence is small (C).*
- ✔ Topical GHK-Cu: plausible copper-enzyme mechanism; small-trial human evidence (C); non-injectable Category 1 under FDA evaluation; whether it reaches the dermis in useful amounts is open. — *Correct. Four separate answers, each with its own source.*
- ✗ Category 1 means FDA has approved GHK-Cu for skin. — *Category 1 means 'still under evaluation' — an enforcement posture, not an approval.*
...
- Local stress axis: CRH → ACTH → cortisol, with feedback
- Local androgen switch: testosterone → DHT in the scalp
- Immune privilege: its collapse drives alopecia areata

<details><summary>Narration script</summary>

Each hair follicle behaves like a small gland. When researchers keep human scalp follicles alive in culture, the follicles answer corticotropin-releasing hormone the way the pituitary and adrenal glands do. They make ACTH and alpha-MSH, they secrete cortisol, and cortisol-like signals feed back to switch the stimulus down. The same follicles run a growth hormone and IGF-1 loop of their own. On the scalp, an enzyme called five-alpha-reductase turns testosterone into dihydrotestosterone, and in genetically susceptible follicles that hormone drives the gradual shrinking behind pattern hair loss. Growing follicles also hide from the immune system. When that protection collapses, immune cells attack the hair bulb, and the result is alopecia areata. Most of this biology comes from tissue kept alive outside the body, so hold it as mechanism, a reason something might matter in patients.
...
| | | |
|---|---|---|
| Patterned thinning? (crown, vertex, frontal recession) | Androgenetic alopecia | Topical minoxidil; finasteride in men; treat coexisting iron or thyroid problems |
| Diffuse shedding after a trigger? (illness, delivery, diet, a drug) | Telogen effluvium | Remove the trigger, reassure, recheck ferritin and TSH |
| Patchy, smooth loss? (with or without nail pitting) | Alopecia areata | Dermatology referral; screen for thyroid and autoimmune disease |
| Signs of androgen excess? (hirsutism, acne, irregular periods) | Hyperandrogenism work-up | Follow the guide's acne and androgen pathway |
| In every patient | Ferritin and TSH | Add androgens if there are virilising signs; a scarring pattern needs a biopsy |

**Callout:** Refer severe or rapidly progressive alopecia areata promptly.

**Exercise (quickfire) · Which pattern is it?** — One fictional patient at a time: where does the workup point?
- Man, 38: a thinning crown and a receding hairline over five years → **Androgenetic pattern** — *Patterned thinning. The guide's first line is topical minoxidil, with finasteride as an option for men; check ferritin and TSH and treat any iron or thyroid problem.*
- Woman, 31: handfuls of hair in the shower three months after giving birth → **Telogen effluvium** — *Diffuse shedding after a trigger. Reassure, and recheck ferritin and TSH.*
- Man, 26: a smooth, round bald patch in the beard, and pitted nails → **Alopecia areata** — *Patchy smooth loss with nail pitting. Refer to dermatology and screen for thyroid and autoimmune disease.*
- Woman, 55: a slowly widening central part, no shedding episode → **Androgenetic pattern** — *Patterned thinning in a woman. Topical minoxidil has randomized-trial support in women; check ferritin and TSH, and androgens if there are virilising signs.*
- Man, 45: diffuse shedding two months after a rapid, very low-calorie diet → **Telogen effluvium** — *A dietary trigger. Address the diet, reassure, and check ferritin and TSH.*
- Woman, 40: several patches that have spread across most of the scalp within weeks → **Alopecia areata** — *Severe or rapidly progressive alopecia areata. The guide asks for prompt referral; JAK inhibitors are specialist treatment.*
...
**Q.** A 32-year-old woman asks for a compounded peptide scalp spray. Diffuse shedding began three months after she gave birth; there are no patches and no signs of androgen excess. What comes first?
- ✗ Start the spray now, since peptides act on the follicle directly. — *That skips the diagnosis. The pattern points to telogen effluvium, and peptide sprays such as PTD-DBM or zinc thymulin have no human trial behind them.*
- ✔ Treat it as likely telogen effluvium: reassure, check ferritin and TSH, and reassess the pattern before any product. — *Correct. Diffuse shedding after a trigger is the guide's telogen-effluvium branch, and ferritin and TSH are checked in everyone.*
- ✗ Refer her for a JAK inhibitor. — *JAK inhibitors are for severe alopecia areata, which shows as patchy, smooth loss. This pattern is different.*
...
- MC1R: pigment of skin and hair
- MC2R: adrenal · MC5R: sebum
- MC3R and MC4R: appetite, in the brain

<details><summary>Narration script</summary>

Pigment starts with hormones the skin makes for itself. Skin cells produce a precursor called POMC and cut it into ACTH, alpha-MSH and beta-endorphin, and the same cells carry the receptors that answer them. There are five melanocortin receptors. MC1R sets the pigment of skin and hair. MC2R is the adrenal receptor for ACTH. MC3R and MC4R work in the brain on appetite, and central receptors also drive sexual responses. MC5R governs sebum. Researchers caution that the real map is messier, with receptors turning up in more tissues than the textbook suggests. For this lesson one idea matters most. A drug that stays on MC1R mostly changes pigment, and a drug that reaches the brain's receptors brings other effects with it.
...
**69 vs 41 h** — median pain-free hours in direct sunlight over six months, afamelanotide vs placebo (US phase 3 trial, 94 adults with EPP) (Langendonk et al., NEJM 2015 · European trial, 74 adults: 6.0 vs 0.8 hours over nine months)  
*Means:* Afamelanotide lets people with EPP spend more time in sunlight without pain. That is approval-grade evidence (A) for one rare disease.  
*Does not mean:* It says nothing about cosmetic tanning, about Melanotan II, or about unsupervised injections. Even in EPP, the US label recommends a full-body skin examination twice a year.
...
- Skin: changing moles, eruptive naevi, melanonychia
- Melanoma: reported, causation unproven
- Systemic: priapism, rhabdomyolysis, encephalopathy

<details><summary>Narration script</summary>

Now the harms, and the kind of evidence behind them. Everything here comes from case reports and reviews, which tell you what can happen and leave open how often it does. In the skin, existing moles darken and grow, new moles erupt in crops, some of them atypical under the microscope, and dark bands can appear in the nails. At least five melanomas have been reported during or after Melanotan use. Each patient had other risk factors, such as fair skin, sunbed use or a family history, so causation is unproven, and the concern rests on a drug that pushes melanocytes to multiply. Beyond the skin, reports describe priapism that needed surgery, a stimulant-like toxic reaction with muscle breakdown and kidney injury, and a brain swelling syndrome that FDA lists among the published serious events.
...
- Almost certainly Melanotan II: approved nowhere, unknown strength and purity
- New and changing naevi and nail pigmentation are the documented harms
- Family history of melanoma: the guide's absolute contraindication

**Exercise (scenario) · What do you do first?** — 

A 27-year-old attends for a skin-quality consultation and mentions injecting a 'tanning peptide' bought online for three months. She has noticed darker moles, several new small ones and a dark stripe along one fingernail. Her mother had melanoma.

- ✗ Reassure her: darker moles are expected with a tan. Review them at her next routine visit. — *New and changing naevi are the documented harm here, dermoscopic changes on Melanotan II can mimic melanoma, and her family history raises the stakes.*
- ✔ Advise stopping now, record the product and seller, and have the whole skin and nails examined promptly, with dermoscopy and baseline photographs, by a dermatologist or skin-cancer clinician. — *Right. Stop the exposure, document it, and have the changing naevi and the nail band assessed and followed. Even the approved MC1R agonist comes with twice-yearly skin examinations, and she has a family history of melanoma.*
- ✗ Offer afamelanotide instead, as the approved version of the same drug. — *Afamelanotide is a different molecule, approved only for erythropoietic protoporphyria as the manufacturer's implant. It is not a tanning product and not a substitute.*

Follow-up: Then document what she used, what you advised and who will follow her skin, and ask whether she bought anything else from the same seller.

**By role**
- *Prescriber:* Examine the skin and nails or refer promptly, document the product and your advice, and decide who will follow her naevi. Do not offer another melanocortin agonist as a substitute.
- *Clinical staff:* Record the product, the seller and how long she used it, photograph the lesions and the nail with consent if your setting allows, and escalate to the prescriber the same day.
- *Advisor:* Advise her to stop and to see a prescriber or dermatologist promptly. Do not suggest another product or seller.

<details><summary>Narration script</summary>

Her booking says skin quality. This patient is fictional, built from the lesson's evidence. She is twenty-seven, and she mentions that she has been injecting a tanning peptide bought online for three months. She has noticed darker moles, several new small ones, and a dark stripe along one fingernail. Her mother had melanoma. The product is almost certainly Melanotan II, approved nowhere and of unknown strength and purity. New and changing moles and nail pigmentation are exactly the harms described in the reports, and in one patient followed with dermoscopy the changes made moles hard to tell from melanoma. The endocrinology guide treats a family history of melanoma as an absolute contraindication. Pick the move that comes first.
...
| | | |
|---|---|---|
| United States · FDA (page current as of 22 April 2026) | Unapproved; nomination withdrawn | FDA's compounding safety page lists Melanotan II among substances withdrawn from Category 2, citing impurity and immunogenicity risks and published reports of melanoma, encephalopathy, sympathomimetic toxicity and priapism |
| United Kingdom · MHRA (17 April 2024) | Unauthorised medicine | Injectable products are classed as medicines; MHRA advises anyone using them to stop immediately and has removed melanotan products from sale for over ten years |
...
**Q.** A patient says, 'Afamelanotide is approved, so Melanotan II is basically the same drug.' What is the accurate reply?
- ✗ Yes. They act on the same receptor, so the approval covers both. — *Sharing MC1R does not make them the same molecule, and an approval attaches to one product and one indication.*
...
- Both: mechanism first, human data absent

<details><summary>Narration script</summary>

Two peptides are sold for hair, and both arrive with better stories than data. PTD-DBM joins a cell-penetrating fragment borrowed from an HIV protein to a short decoy sequence. Inside follicle cells, the decoy keeps a protein called CXXC5 from binding its partner, Dishevelled, and that releases a brake on Wnt signalling, a pathway involved in hair regrowth. In mice, hair regrew faster and follicles formed in healed wounds. The work came from the developer's own group. Zinc thymulin is a thymic hormone that becomes active only when zinc binds to it. How it might help hair has never been defined, and nobody has shown whether any effect would come from the peptide or from the zinc. Hold both as mechanism, and look for the human trial.
...
**0** — human trials of PTD-DBM, published or registered (September 2026) (Lee et al., J Invest Dermatol 2017: mice, plus CXXC5 measured in human scalp tissue)  
*Means:* Whether PTD-DBM regrows human hair is unknown. The Peptide Pocket Guide and this course grade it D.  
*Does not mean:* It does not show that PTD-DBM fails or harms. One open safety question sits alongside: the 2025 review flags that off-target Wnt activation is associated with colorectal and liver cancers, a theoretical concern nobody has tested for this peptide.
...
| | | |
|---|---|---|
| Topical minoxidil | Regrowth in pattern hair loss | Scalp solution or foam |
| Oral finasteride | Slows pattern hair loss in men | 5α-reductase inhibitor |
| Baricitinib | Regrowth in severe alopecia areata | Oral JAK inhibitor |
| PTD-DBM spray | Regrowth in pattern hair loss | Wnt activator, compounded or research-grade |
| Zinc thymulin spray | Thicker, fuller hair | Zinc-bound thymic peptide, compounded |

**Callout:** A plausible pathway is a reason to run a trial. The trial is what you grade.

**Exercise (classify) · Trial or theory?** — Tap what stands behind each one.
- Topical minoxidil → **Approved, with randomized trials** — *GRADE A. Meta-analysed randomized trials show benefit in men and women; in the US it has been FDA-approved since 1988 and is sold over the counter.*
- Oral finasteride → **Approved, with randomized trials** — *GRADE A in men. Meta-analysed randomized trials; in the US a prescription drug for hair loss since 1997.*
- Baricitinib → **Approved, with randomized trials** — *GRADE A. Two phase 3 trials in 1,200 adults; FDA-approved for adults with severe alopecia areata in June 2022.*
- PTD-DBM spray → **No human trial** — *GRADE D. One 2017 study in mice and scalp tissue from the developer's group; no human trial published or registered; on none of FDA's 503A lists.*
- Zinc thymulin spray → **No human trial** — *GRADE D. No indexed human hair study; the guide's cited case series could not be found. In the US, thymulin acetate sits in 503A Category 3, nominated without adequate support.*
...
**Q.** A patient with pattern thinning asks whether a compounded PTD-DBM spray is 'the new minoxidil'. What does the evidence support?
- ✗ Yes. It acts on the Wnt pathway, which drives hair growth. — *That is a mechanism argument. There is no human trial of PTD-DBM, so 'works like minoxidil' has nothing behind it.*
...
**Exercise (chips) · Your follicle and pigment checklist** — Tap everything you will do. Choose as many as you like.
*Before my next hair or tanning conversation I will …* work up the hair loss before any product · name the evidence grade out loud · ask exactly what was injected or sprayed, and from where · examine or refer new or changing moles · ask about a personal or family history of melanoma · check the product's current status with my regulator

**By role**
- *Prescriber:* Your checklist ends with documentation: the product the patient used, the grade you quoted, and your referral.
- *Clinical staff:* Your checklist ends with escalation: melanocortin use, new moles or patchy hair loss go to the prescriber the same day.
- *Advisor:* Your checklist ends with referral: product facts you can give; skin changes and a hair-loss diagnosis go to a prescriber.

<sub>Sources: Aesthetic & Regenerative Endocrinology — A Clinician's Pocket Guide 2026 · Böhm M 2025</sub>


## Module check

**Q.** Closing Module 5: which statement keeps the four registers apart for Melanotan II?
- ✗ It shares afamelanotide's receptor, so it shares afamelanotide's approval. — *That blends mechanism into regulatory status. The approval belongs to afamelanotide, for EPP only.*
- ✔ Mechanism: a non-selective melanocortin agonist. Evidence: two tiny 1990s studies and case reports of harm (D). Status: approved nowhere, with US, UK and Australian regulators on record against it. Open question: whether it causes melanoma. — *Correct. Four separate answers, each with its own source.*
- ✗ Because melanoma causation is unproven, it is safe to use with monitoring. — *An unproven cause is an open question and offers no reassurance; the documented harms and the lack of approval still stand.*
...
## Lesson 6.1 · Growth hormone and IGF-1 in skin homeostasis

### 01 / 19 · Real endocrinology, borrowed for marketing.  
*Module 06 · The growth-hormone axis and the skin · title*

Growth hormone and IGF-1 genuinely shape skin, and one peptide on this axis has approval-grade trials. Most of what patients are offered has much less behind it. In three lessons you will separate the physiology from the promise, the approved from the anecdotal, and the side-effects you can see from the risks nobody has measured.
...
Growth hormone acts mostly in the dermis. Its receptor is expressed more by fibroblasts than by keratinocytes, and it increases fibroblast numbers and supports collagen synthesis. IGF-1, made locally by fibroblasts and melanocytes, reaches keratinocytes through the IGF-1 receptor and makes them divide. Human hair follicles even run their own small growth-hormone loop in the laboratory. With age, GH secretion and IGF-1 fall steadily; this is the somatopause.

- GH: dermal fibroblasts and collagen
- IGF-1: keratinocyte proliferation, supplied locally
- Somatopause: GH and IGF-1 fall with age

<details><summary>Narration script</summary>

Two layers of skin listen to two different parts of the same axis. Growth hormone speaks mainly to the dermis. Its receptor is expressed more on fibroblasts than on keratinocytes, and in culture growth hormone increases fibroblast numbers and supports collagen synthesis, sometimes directly and sometimes through IGF-1. The epidermis listens to IGF-1. Keratinocytes carry the IGF-1 receptor, their neighbours in the dermis supply the hormone, and in culture IGF-1 makes keratinocytes divide where growth hormone on its own does nothing. Human hair follicles even keep a small growth-hormone loop running when they are cultured outside the body. With age, growth-hormone pulses and IGF-1 fall steadily, a change called the somatopause. Hold all of this as mechanism. It explains why the axis could matter for skin. Whether changing it helps a patient is a separate question, and the trials answer it.
...
### 03 / 19 · A much-cited skin result, read again.  
*Human evidence · stat*

In 1990 a much-cited New England Journal of Medicine study gave growth hormone for six months to 12 healthy men over 60, with nine untreated men for comparison and no placebo. Lean mass rose and fat fell. Skin thickness rose 7.1%, with P = 0.07, short of statistical significance. A small 1996 randomized trial in 28 older men found 15% more collagen laid down in implanted wound tubes on GH, a laboratory surrogate for repair.

**7.1%** — rise in skin thickness in 12 older men given growth hormone for six months (1990) (P = 0.07 · nine untreated men as comparison · no placebo)  
*Means:* A skin result still quoted for growth hormone comes from 12 treated men, without a placebo, and it missed statistical significance. Graded on its design, it is D.  
*Does not mean:* It does not show that GH thins skin or that it fails in true deficiency, and it says nothing about secretagogues. It shows how thin the direct skin evidence for growth hormone in healthy ageing is.

<sub>Sources: Rudman D 1990 · Papadakis MA 1996</sub>

### 04 / 19 · Mechanism, human evidence or open question?  
*Sort the evidence · tool*

Six things you will hear about growth hormone and skin, each accurate as worded. Before you see the answer, decide what kind of statement each one is.

| | | |
|---|---|---|
| Keratinocytes | IGF-1 makes them divide in culture; GH alone does not | 1992 |
| GH deficiency | Adults with untreated deficiency have a thinner epidermis on biopsy | 2001 |
| Major burns | GH shortened donor-site healing by about three days in adults | 2014 |
| Hair follicle | Follicles keep a GH–IGF-1 loop running outside the body | 2023 |
| Acromegaly | Glycosaminoglycan deposits and oedema thicken and puff the skin | 2006 |
| Healthy adults | Whether raising GH or IGF-1 makes facial skin look younger | — |

**Callout:** Knowing what growth hormone does to skin in disease is different from knowing what it does to healthy skin.

**Exercise (classify) · Which register?** — Tap the kind of statement each one is.
- IGF-1 makes keratinocytes divide in culture; GH alone does not → **Mechanism** — *Mechanism (D). Cell-culture work from 1992 explains a pathway; it tells you nothing about a patient's skin.*
- Adults with untreated GH deficiency have a thinner epidermis on biopsy → **Human evidence** — *Human evidence (C), small and observational: 45 people biopsied in 2001. Treatment of childhood-onset deficiency did not fully normalise the skin.*
- GH shortened donor-site healing in adults with major burns → **Human evidence** — *Human evidence (C): 13 small randomized trials pooled by Cochrane in 2014, with more hyperglycaemia on GH and a risk of bias. Burns over 40% of the body, far from cosmetic use.*
- Hair follicles keep a GH–IGF-1 loop running outside the body → **Mechanism** — *Mechanism (D). An ex vivo finding from 2023 about follicle biology.*
- In acromegaly, glycosaminoglycan deposits and oedema thicken the skin → **Human evidence** — *Human evidence from disease. It shows what too much growth hormone does to skin, and says nothing about a cosmetic benefit.*
- Whether raising GH or IGF-1 makes a healthy adult's facial skin look younger → **Open question** — *Open question. No randomized trial has measured it, and the 1990 skin result missed statistical significance.*

<sub>Sources: Tavakkol A 1992 · Lange M 2001 · Breederveld RS 2014 · Horesh EJ 2023 · Ben-Shlomo A 2006 · Rudman D 1990 · Edmondson SR 2003</sub>
...
- US: anti-ageing distribution is a federal offence
...
- *Clinical staff:* If a patient mentions growth hormone or 'HGH' for skin or energy, record what they use, where it comes from and any swelling, joint pain or tingling, and bring it to the prescriber.
- *Advisor:* You can explain that growth hormone falls normally with age and that trials in healthy adults show more side-effects than benefit. Anyone who wants to start it needs a prescriber's assessment rather than a product recommendation.

**Regulatory status by jurisdiction**
- *GB:* In the UK, somatropin is a prescription-only medicine licensed for growth hormone deficiency and specific growth disorders, and a Class C controlled drug. <sub>(Pfizer Limited (marketing authorisation holder) 2024 · Misuse of Drugs Act 1971 (UK) 1971)</sub>
- *EU:* In the EU, somatropin medicines have been authorised since the 1980s, through central and national procedures, for growth hormone replacement and for short stature in specific childhood conditions (EMA, 2012). The centrally authorised Omnitrope (since 12 April 2006) is prescription-only, and treatment is started and monitored by a doctor experienced in growth disorders. <sub>(eu-ema-ref-somatropin-2012 · eu-ema-epar-omnitrope)</sub>
- *PT:* In Portugal, somatropin medicines are authorised as restricted-prescription medicines, reserved for conditions diagnosed only in hospital or specialised settings, and INFARMED's register gives them no narcotic classification (25 September 2026). Growth hormone is distributed free of charge through hospitals with endocrinology or paediatric services, and a national commission (CNNHC) sets the conditions for its administration. <sub>(pt-infomed · pt-dl176-2006 · pt-infarmed-cnnhc · pt-portaria117-2019)</sub>
- *BR:* In Brazil, somatropin is registered for replacement therapy in adults with marked growth hormone deficiency, and it is a controlled substance on List C5 (anabolic substances) that needs a special-control prescription in two copies (RDC 1.036/2026). The Federal Council of Medicine's Resolution 1.999/2012, in force in September 2026, bars the use of hormones, including growth hormone, except in diagnosed deficiencies where replacement shows evidence of scientifically proven benefit. <sub>(br-label-genotropin · br-anvisa-register-opendata · br-rdc-1036-2026 · br-anvisa-controlled-lists-page · br-cfm-1999-2012 · br-cfm-norms-search)</sub>
- *AE:* In the UAE, the Emirates Drug Establishment (EDE) has held medicines registration since Federal Decree-Law 28/2023; the medicines law is Federal Decree-Law 38 of 2024, which prohibits advertising semi-controlled products to the public. Somatropin is registered with the EDE and is on the federal list of semi-controlled medical products (MOHAP Ministerial Decision 306/2023), and every somatropin entry in the EDE register is dispensed as a semi-controlled drug (25 September 2026). <sub>(ae-fdl-28-2023 · ae-fdl-38-2024 · ae-ede-reg-genotropin · ae-ede-register · ae-mohap-md-306-2023)</sub>
...
One question to close lesson 6.1.

**Q.** Fictional chart note: a healthy 58-year-old asks for growth hormone 'for her skin' after an online test reported her IGF-1 as 'below the range for a 30-year-old'. She has no pituitary history. What does the evidence support?
- ✗ Start growth hormone, because restoring a youthful IGF-1 thickens skin. — *The much-cited skin result for that idea missed statistical significance, and trials in healthy adults show more side-effects than benefit.*
- ✔ Read her IGF-1 against an age-matched range; without a diagnosed deficiency, the trials show small gains and more side-effects, so growth hormone is not the answer. — *Correct. A low-for-young IGF-1 is often normal for age, and the healthy-ageing trials point against treatment.*
- ✗ Offer a secretagogue instead, because it raises her own growth hormone more gently. — *That is a mechanism argument. No secretagogue has trial evidence of benefit for skin or healthy ageing, as lesson 6.2 shows.*


## Lesson 6.2 · GHRH analogues and secretagogues: clinical pharmacology

### 07 / 19 · One axis, four ways in.  
*Lesson 6.2 · Concept · audio*

Somatropin is growth hormone itself. GHRH analogues (sermorelin, tesamorelin, CJC-1295) stimulate the pituitary's GHRH receptor. Ghrelin-receptor agonists (ipamorelin, GHRP-2, GHRP-6 and the oral ibutamoren, MK-677) stimulate GH release through a second pituitary receptor. IGF-1 analogues such as IGF-1 LR3 bypass the pituitary altogether. They are sold as one family, and the next moments take them apart.

- Replace: somatropin
- Stimulate: GHRH analogues and ghrelin-receptor agonists
- Bypass: IGF-1 analogues

<details><summary>Narration script</summary>

Four routes lead into the same axis, and patients rarely know which one they are on. Somatropin is growth hormone itself, made by recombinant technology. GHRH analogues, sermorelin, tesamorelin and CJC-1295, press on the pituitary's releasing-hormone receptor, so the gland releases its own growth hormone in pulses. Ghrelin-receptor agonists, ipamorelin, GHRP-2, GHRP-6 and the oral compound ibutamoren, press on a second pituitary receptor. IGF-1 analogues such as IGF-1 LR3 skip the pituitary and act on the IGF-1 receptor directly. Every route ends at that same receptor, which is why lesson three treats their risks together. Clinics often sell all of these as one family with one promise. Keep them apart, because the trials, the approvals and the side-effects belong to each molecule separately.

</details>

<sub>Sources: Dominikowski A 2026 · Teichman SL 2006 · Nass R 2008 · Pfizer (FDA-approved labeling) 2026 · Aesthetic & Regenerative Endocrinology — A Clinician's Pocket Guide 2026 · The Peptide Pocket Guide — 2026 Edition · Clinical Reference (seventy-two entries) 2026</sub>

### 08 / 19 · What real peptide evidence looks like.  
*Worked example · tool*

Tesamorelin is the instructive exception on this axis. Both Hormonaly guides grade it A, for one indication. Read the record in order.
...
**Regulatory status by jurisdiction**
- *GB:* UK status (MHRA products database, 25 September 2026): no UK product information. A search for tesamorelin returned no summary of product characteristics, patient leaflet or assessment report. <sub>(Medicines and Healthcare products Regulatory Agency (UK) 2026)</sub>
- *EU:* In the EU, tesamorelin has no marketing authorisation: the application for Egrifta (excess abdominal fat in HIV lipodystrophy) was withdrawn on 21 June 2012, when the provisional view of EMA's human-medicines committee (CHMP) was that it could not be approved, partly because raised IGF-1 was a major safety concern. <sub>(eu-ema-egrifta-withdrawal · eu-union-register)</sub>
- *BR:* In Brazil, no registered medicine containing tesamorelin, including Egrifta, was found in ANVISA's register or online search (25 September 2026). <sub>(br-anvisa-register-opendata · br-anvisa-register-dictionary · br-anvisa-consultas-medicamentos)</sub>
- *AE:* In the UAE, the Emirates Drug Establishment (EDE) has held medicines registration since Federal Decree-Law 28/2023; the medicines law is Federal Decree-Law 38 of 2024. No registered product containing tesamorelin, and none named Egrifta, was found in the EDE register (25 September 2026). In Dubai, the DHA prohibits prescribing, dispensing or using any peptide product that is not registered or licensed with the EDE (29 July 2026); in Abu Dhabi, physicians may prescribe peptide therapies only for clinical indications supported by available scientific evidence, after a documented eligibility assessment and with informed consent that covers the product's regulatory approval status (DoH, 31 July 2026). <sub>(ae-fdl-28-2023 · ae-fdl-38-2024 · ae-ede-register · ae-dha-cir-peptides-2026 · ae-doh-cir-148-2026)</sub>
...
A PubMed search in September 2026 found no randomized trial with a skin outcome for tesamorelin, CJC-1295, ipamorelin or IGF-1 LR3. The nearest is a 1997 study of a GHRH(1-29) analogue related to sermorelin, in 19 older adults. Skin thickness measured by caliper rose after 16 weeks, compared with a placebo lead-in rather than a parallel control group.

**0** — randomized trials with a skin outcome for tesamorelin, CJC-1295, ipamorelin or IGF-1 LR3 (PubMed, September 2026) (Closest: a 1997 single-blind study of a GHRH(1-29) analogue, 19 older adults, skin thickness by caliper)  
*Means:* Every skin promise made for these peptides rests on mechanism and anecdote. The nearest data are one small study without a parallel control group (D).  
*Does not mean:* It does not show these peptides harm skin or do nothing for it. It shows the question has never been properly tested, and a clinic brochure cannot fill that gap.

<sub>Sources: Khorram O 1997 · Dominikowski A 2026 · The Peptide Pocket Guide — 2026 Edition · Clinical Reference (seventy-two entries) 2026</sub>

### 10 / 19 · Approval-grade, hormone levels, or nothing?  
*Sort the evidence · tool*

Seven products on this axis and the use each one is offered for. Decide what actually stands behind each before you see its grade.

| | | |
|---|---|---|
| Tesamorelin | Less visceral fat in HIV-associated lipodystrophy | GHRH analogue |
| Somatropin | Treats adult growth-hormone deficiency | Recombinant GH |
| Sermorelin | Youthful GH levels in healthy adults | GHRH(1-29) |
| CJC-1295 with DAC | A weeks-long GH boost for skin and recovery | Long-acting GHRH analogue |
| CJC-1295 without DAC ('Mod GRF 1-29') | Pulsed GH for skin and sleep | GHRH analogue |
| Ipamorelin | 'Clean' GH release for anti-ageing | Ghrelin-receptor agonist |
| IGF-1 LR3 | Muscle and skin repair | IGF-1 analogue |

**Callout:** A higher IGF-1 is a laboratory result. Benefit to a patient needs a clinical trial.

**Exercise (quickfire) · What stands behind it?** — One product at a time: approval-grade trials, hormone levels only, or no human studies?
- Tesamorelin, for HIV-associated abdominal fat → **Approval-grade trials for this use** — *GRADE A. Two phase 3 trials and FDA approval in 2010, for this indication and no other.*
- Somatropin, for adult GH deficiency → **Approval-grade trials for this use** — *GRADE A for diagnosed deficiency, on decades of trials. For healthy ageing, the trials show more side-effects than benefit.*
- Sermorelin, for youthful GH in healthy adults → **Hormone levels rise; no benefit shown** — *In this course, GRADE D for this use. Small studies show GH and IGF-1 rising; none shows a clinical or skin benefit. Its former US approval was for children with GH deficiency.*
- CJC-1295 with DAC, for skin and recovery → **Hormone levels rise; no benefit shown** — *GRADE D for any clinical use. Two phase 1 trials in healthy adults showed GH and IGF-1 rising for days; neither measured a clinical outcome. The Hormonaly guides rate it C; the trials stop at hormone levels.*
- CJC-1295 without DAC, for skin and sleep → **No published human studies** — *GRADE D. No peer-reviewed human study of this form exists; its promises are borrowed from sermorelin and from the DAC version.*
- Ipamorelin, for anti-ageing → **Hormone levels rise; no benefit shown** — *GRADE D for anti-ageing and skin. Human studies show GH release; its only phase 2 trial, in postoperative ileus, showed no benefit over placebo.*
- IGF-1 LR3, for muscle and skin repair → **No published human studies** — *GRADE D. No peer-reviewed human study; mechanism and user reports only.*

<sub>Sources: Falutz J 2007 · Pfizer (FDA-approved labeling) 2026 · Teichman SL 2006 · Beck DE 2014 · Dominikowski A 2026 · US Food and Drug Administration 2013 · Aesthetic & Regenerative Endocrinology — A Clinician's Pocket Guide 2026 · The Peptide Pocket Guide — 2026 Edition · Clinical Reference (seventy-two entries) 2026</sub>

### 11 / 19 · Where each one stands in the US.  
*Regulatory status · tool*

Dated to FDA's 503A category list of 14 May 2026, its Category 2 page (current as of 22 April 2026), the October 2024 advisory-committee votes, the bulks list in 21 CFR 216.23 and Drugs@FDA as checked on 24 September 2026. Absence from every list does not make a substance permitted, and FDA stopped placing newly nominated substances into categories in January 2025.

| | | |
|---|---|---|
| Somatropin · tesamorelin | FDA-approved for defined indications | Growth-hormone deficiency and specific growth disorders; HIV-associated abdominal fat. Knowingly distributing growth hormone for other uses, anti-ageing included, is a federal offence (21 U.S.C. 333(e)). |
| Sermorelin | No approved product on the market | Approved as Geref in 1990 and 1997, discontinued in 2008, approvals withdrawn in 2009 at the maker's request; FDA found in 2013 that this was not for safety or effectiveness reasons. In no 503A category. |
| Ibutamoren (MK-677) | 503A and 503B Category 2 | FDA cites a heart-failure signal that stopped a hip-fracture trial early. The advisory committee voted 13 to 1 against adding it to the bulks list (October 2024). |
| Ipamorelin · CJC-1295 | Withdrawn 503A nominations | FDA lists both among Category 2 nominations that were withdrawn, citing serious adverse events; ipamorelin remains in 503B Category 2. The committee voted 0 to 12, with one abstention, against listing ipamorelin (October 2024). |
| GHRP-2 · GHRP-6 | 503A Category 3 | Nominated without adequate support for FDA to evaluate; both in 503B Category 2. |
| IGF-1 LR3 | No approved product, no category | Named in a 2020 FDA warning letter, with CJC-1295, ipamorelin, GHRP-2, GHRP-6 and MK-677, as ineligible for the 503A exemptions. |

**Callout:** The 503A bulks list holds six substances, none on this axis. Check the live lists before any conversation about compounding.

**Regulatory status by jurisdiction**
- *EU:* In the EU, somatropin has been authorised since the 1980s for growth hormone replacement and short stature in specific childhood conditions, while tesamorelin has no marketing authorisation (its application was withdrawn on 21 June 2012). No centrally authorised medicine containing sermorelin, ipamorelin or CJC-1295 was found in the Union Register or EMA's data (25 September 2026), and ibutamoren (MK-677) is not an authorised medicine: its orphan designation for growth hormone deficiency (20 June 2017) is, as EMA states, not a marketing authorisation. <sub>(eu-ema-ref-somatropin-2012 · eu-ema-egrifta-withdrawal · eu-union-register · eu-ema-medicines-data · eu-ema-od-ibutamoren-2017)</sub>
- *PT:* In Portugal, no medicine containing tesamorelin, sermorelin, ipamorelin, CJC-1295 or ibutamoren (MK-677) is listed in INFARMED's Infomed register, which includes authorised, lapsed and revoked products (25 September 2026). Compounded medicines may use only raw materials listed in the Portuguese or European pharmacopoeia, another European pharmacopoeia or compendial scientific documentation, and one containing any other raw material may not be prescribed (Decreto-Lei 95/2004). <sub>(pt-infomed · pt-dl95-2004 · pt-infarmed-manipulados)</sub>
- *BR:* In Brazil, no registered medicine containing tesamorelin or sermorelin was found in ANVISA's register (25 September 2026), and ANVISA stated on 2 July 2026 that CJC-1295 and ipamorelin products are not registered with ANVISA and that any substance must have passed efficacy and safety assessment before it can be compounded. Ibutamoren is not a registered medicine, and ANVISA refused the clinical-trial petitions for ibutamoren mesylate on 9 June 2026. <sub>(br-anvisa-register-opendata · br-anvisa-register-dictionary · br-anvisa-consultas-medicamentos · br-anvisa-peptides-2026 · br-dou-re-2318-2026)</sub>
- *AE:* In the UAE, the Emirates Drug Establishment (EDE) has held medicines registration since Federal Decree-Law 28/2023; the medicines law is Federal Decree-Law 38 of 2024. Somatropin is registered and dispensed as a semi-controlled drug, while no registered product containing tesamorelin, sermorelin, ipamorelin, CJC-1295 or ibutamoren was found in the EDE register (25 September 2026). In Dubai, the DHA prohibits prescribing, dispensing or using any peptide product that is not registered or licensed with the EDE (29 July 2026); in Abu Dhabi, the DoH's compounding standard treats peptides as non-monographed, high-risk substances and lets novel substances of unknown risk be compounded only if monographed, part of an approved medicine or listed on the DoH Registry for Compounded Substances (August 2026). <sub>(ae-fdl-28-2023 · ae-fdl-38-2024 · ae-ede-reg-genotropin · ae-ede-register · ae-dha-cir-peptides-2026 · ae-doh-compounding-std-2026)</sub>

<sub>Sources: US Food and Drug Administration 2026 · US Food and Drug Administration 2026 · US Food and Drug Administration 2024 · Code of Federal Regulations (eCFR) 2026 · US Food and Drug Administration 2026 · US Food and Drug Administration 2013 · US Food and Drug Administration 2020 · US Food and Drug Administration 2026 · Office of the Law Revision Counsel 2026 · Theratechnologies Inc. (FDA-approved labeling) 2026 · Adunsky A 2011</sub>
...
**Regulatory status by jurisdiction**
- *GB:* In the UK, MHRA's products database holds no product information for tesamorelin, sermorelin or ipamorelin (searched 25 September 2026), so any of them would reach a patient only as an unlicensed medicine. An unlicensed special needs a clinical need that no licensed medicine meets. <sub>(Medicines and Healthcare products Regulatory Agency (UK) 2026 · Medicines and Healthcare products Regulatory Agency (UK) 2023)</sub>
- *EU:* In the EU, tesamorelin has no marketing authorisation (its application was withdrawn on 21 June 2012), and no centrally authorised medicine containing sermorelin or ipamorelin was found in the Union Register or EMA's data (25 September 2026). EU law lets each member state, under its own legislation, allow an unauthorised medicine for an individual patient on a bona fide unsolicited order from an authorised health professional, under that professional's direct personal responsibility (Directive 2001/83/EC, Article 5(1)). <sub>(eu-ema-egrifta-withdrawal · eu-union-register · eu-ema-medicines-data · eu-dir-2001-83)</sub>
- *PT:* In Portugal, no medicine containing tesamorelin, sermorelin or ipamorelin is listed in INFARMED's Infomed register, which includes authorised, lapsed and revoked products (25 September 2026). INFARMED may authorise exceptional use (AUE) of a medicine without a marketing authorisation, for example when it is clinically justified as indispensable and no authorised alternative exists (Estatuto do Medicamento). <sub>(pt-infomed · pt-dl176-2006 · pt-infarmed-aue)</sub>
- *BR:* In Brazil, no registered medicine containing tesamorelin or sermorelin was found in ANVISA's register (25 September 2026). ANVISA stated on 2 July 2026 that products presented as peptides called ipamorelin that promise aesthetic effects or health improvements are not registered with ANVISA, and that some injectable peptides are not regularised in any category and are therefore illegal for any health use, including aesthetic use. <sub>(br-anvisa-register-opendata · br-anvisa-register-dictionary · br-anvisa-consultas-medicamentos · br-anvisa-peptides-2026)</sub>
- *AE:* In the UAE, the Emirates Drug Establishment (EDE) has held medicines registration since Federal Decree-Law 28/2023; the medicines law is Federal Decree-Law 38 of 2024. No registered product containing tesamorelin, sermorelin or ipamorelin was found in the EDE register (25 September 2026). In Dubai, the DHA prohibits prescribing, dispensing or using any peptide product that is not registered or licensed with the EDE and bans misleading or unproven anti-ageing claims for peptides (29 July 2026); in Abu Dhabi, physicians may prescribe peptide therapies only for clinical indications supported by available scientific evidence, after a documented eligibility assessment and with informed consent that covers the product's regulatory approval status (DoH, 31 July 2026). <sub>(ae-fdl-28-2023 · ae-fdl-38-2024 · ae-ede-register · ae-dha-cir-peptides-2026 · ae-doh-cir-148-2026)</sub>

<details><summary>Narration script</summary>

Imagine the request as it usually arrives. A patient says their clinic offers a peptide that raises growth hormone naturally, for skin and sleep, and asks what you think. Three answers come before anything else. First, which molecule, exactly, because CJC-1295 with and without its albumin-binding tail are two different products, and only the version with the tail has been tested in people. Second, what stands behind it. Tesamorelin has approval-grade trials for visceral fat in people with HIV, and the rest stop at hormone levels or have never been studied in humans. Third, where it stands in the United States today, read off FDA's live lists. As of September 2026, none of the growth-hormone secretagogues sits on the 503A bulks list.
...
One question to close lesson 6.2.

**Q.** Fictional chart note: a 47-year-old has been prescribed a compounded 'CJC-1295/ipamorelin' product by a wellness clinic for skin quality. She asks whether it is 'basically tesamorelin'. What is the most accurate answer?
- ✗ Yes. Both work on the growth-hormone pathway, so tesamorelin's approval covers the class. — *An approval and its GRADE A belong to tesamorelin, for HIV-associated abdominal fat. They do not transfer to other molecules or uses.*
- ✔ No. Tesamorelin has phase 3 trials and a US approval for HIV-associated abdominal fat; CJC-1295 and ipamorelin have hormone-level data at best and no skin trials; neither is on the US 503A bulks list. — *Correct. Different molecules, different evidence, different regulatory standing.*
- ✗ Yes, provided the compounding pharmacy is licensed. — *A licensed pharmacy changes neither the evidence nor the fact that, in the US, these substances have no bulks-list standing.*


## Lesson 6.3 · GH excess, oedema and mitogenic risk

### 14 / 19 · What too much growth hormone looks like.  
*Lesson 6.3 · Recognition · audio*

Sustained GH excess changes skin in ways you can see. In acromegaly, glycosaminoglycan deposits and oedema make the face, hands and feet puffy and thick; the skin turns oily with large pores; sweating increases; skin tags and acanthosis nigricans appear. Drugs on this axis bring their own signs: fluid retention with swelling, joint pain, tingling and carpal tunnel symptoms. The Endocrine Society recommends measuring IGF-1 when typical acral and facial features are present.

- Soft tissue: puffy, thickened face, hands and feet
- Skin: oily, sweaty, skin tags, acanthosis nigricans
- On treatment: swelling, joint pain, tingling

<details><summary>Narration script</summary>

Excess growth hormone leaves visible marks on skin and soft tissue, and noticing them early matters. In acromegaly, glycosaminoglycan deposits and oedema thicken the face, hands and feet, so features look puffy and coarse. The skin turns oily with large pores, sweating increases, and skin tags and acanthosis nigricans appear. Hands and feet enlarge slowly, and the jaw widens. Drugs on this axis bring their own signs, usually transient, with swelling, joint pain, tingling fingers and carpal tunnel symptoms. On somatropin, the label asks for existing moles to be watched for growth or malignant change. The Endocrine Society recommends measuring IGF-1 when typical acral and facial features are present, and suggests it when several associated conditions cluster. For most of you the job is recognition and referral, and the diagnosis belongs to endocrinology.

</details>

<sub>Sources: Ben-Shlomo A 2006 · Katznelson L 2014 · Giustina A 2024 · Pfizer (FDA-approved labeling) 2026 · Liu H 2007</sub>

### 15 / 19 · Does raising IGF-1 cause cancer?  
*Four registers · tool*

The honest answer has four parts, and each has its own source. Keep them apart, or a mechanism will be heard as a measured risk.

| | | |
|---|---|---|
| Mechanism | Plausible | IGF-1 receptor signalling drives cell proliferation and survival, which gives any IGF-1-raising product a theoretical concern |
| Human observation | Modest associations | In large studies, higher natural IGF-1 goes with slightly higher risks of prostate, breast, colorectal and thyroid cancer; reverse causation is not excluded. In one Ecuadorian cohort, people with GH-receptor deficiency had almost no cancer. |
| Acromegaly | Slightly raised, inconsistently | Pooled studies show about 1.5 times the expected cancer incidence, with the highest estimates from small single-centre series; a Danish nationwide cohort found no clear rise |
| GH replacement | Largely reassuring | No clear raised risk in 23,984 GH-treated children with growth failure and no other disease; a 2022 consensus found no link with primary tumours or recurrence in survivors |
| Open question | Unmeasured | No long-term cancer data exist for secretagogues or IGF-1 LR3 used for ageing or skin |

**Callout:** A plausible mechanism plus a modest association is a reason for caution and consent. It is a different thing from a measured risk.

<sub>Sources: Edmondson SR 2003 · Renehan AG 2004 · Knuppel A 2020 · Dal J 2018 · Swerdlow AJ 2017 · Boguszewski MCS 2022 · Guevara-Aguirre J 2011 · Dominikowski A 2026</sub>

### 16 / 19 · Half the patients on the approved one.  
*The evidence · stat*

Tesamorelin is the best-studied peptide on this axis. In its pivotal trials, 47% of treated patients had IGF-1 more than two standard deviations above the mean at 26 weeks, and 36% more than three. Its label states that the effects of prolonged IGF-1 elevation are unknown. For unapproved secretagogues bought for skin, nobody has published the equivalent figure.

**47%** — of tesamorelin-treated patients with IGF-1 above +2 SD at 26 weeks in its pivotal trials (36% above +3 SD · label: effects of prolonged elevation unknown)  
*Means:* Pushing IGF-1 above the normal range is common even with an approved GHRH analogue used as labelled, in monitored trials.  
*Does not mean:* It does not show that tesamorelin causes cancer, and it is no target to aim for. It shows why sustained, unmonitored use of any IGF-1-raising product is an open safety question.

<sub>Sources: Theratechnologies Inc. (FDA-approved labeling) 2026 · Falutz J 2010 · Dominikowski A 2026</sub>

### 17 / 19 · Tight rings, eight months into 'CJC/ipa'.  
*Fictional case · audio*

A 52-year-old patient has injected a clinic-supplied 'CJC-1295/ipamorelin' product for eight months for skin and recovery. Her rings no longer fit, her face and hands look puffy, her fingers tingle at night, she sweats more, and new skin tags have appeared on her neck. She asks for a stronger version. This case is fictional, built from the lesson's evidence; there is one best first step.

- Tight rings, puffy hands and face
- Night-time tingling, sweating, new skin tags
- An unapproved product with no skin trials

**Exercise (scenario) · What do you do first?** — 

A 52-year-old patient has injected a clinic-supplied 'CJC-1295/ipamorelin' product for eight months for skin and recovery. Her rings no longer fit, her face and hands look puffy, her fingers tingle at night, she sweats more, and new skin tags have appeared on her neck. She asks for a stronger version.

- ✗ Reassure her that mild water retention is expected on growth-hormone peptides and review in three months. — *Fluid retention is a known effect, but this cluster is the pattern the Endocrine Society says should prompt IGF-1 testing. Three more months on an unmonitored product leaves it unassessed.*
- ✔ Advise stopping the product, record exactly what she used, from where and for how long, and route her promptly to a prescriber for assessment of GH excess, including IGF-1. — *Right. Stop the exposure, capture the product details, and get the signs assessed. Fluid retention on these agents usually settles when treatment stops; signs that persist need an endocrine work-up.*
- ✗ Switch her to tesamorelin, since it is FDA-approved. — *Tesamorelin's approval covers HIV-associated abdominal fat, and it pushes IGF-1 above the normal range in about half of treated patients. It would add to the problem.*

Follow-up: Then document the conversation: the product and its source, the signs you saw, what you advised, and who assesses her next.

**By role**
- *Prescriber:* You examine for acral and facial change, measure IGF-1 or refer to endocrinology, check glucose and blood pressure, and document the unapproved product and your advice.
- *Clinical staff:* You record the product name, supplier and duration, note the swelling and tingling, and escalate to the prescriber the same day.
- *Advisor:* You advise her to stop, keep the vial and packaging, and see a prescriber promptly; you do not suggest a stronger product or another supplier.

<details><summary>Narration script</summary>

This patient is fictional, built from the lesson's evidence. She is fifty-two and has injected a clinic-supplied product labelled CJC-1295 and ipamorelin for eight months, for skin and recovery. Her rings no longer fit. Her face and hands look puffy, her fingers tingle at night, she sweats more than she used to, and small skin tags have appeared on her neck. She likes her skin and asks for a stronger version. Read the cluster before the request. Swollen hands and face, tingling, sweating and new skin tags together make up the soft-tissue pattern of growth-hormone excess, and carpal tunnel symptoms and heavy sweating are among the conditions that prompt an IGF-1 test. Neither peptide has a skin trial behind it. Choose the move you would make first.

</details>

<sub>Sources: Katznelson L 2014 · Ben-Shlomo A 2006 · Giustina A 2024 · Theratechnologies Inc. (FDA-approved labeling) 2026 · US Food and Drug Administration 2026 · Dominikowski A 2026 · The Peptide Pocket Guide — 2026 Edition · Clinical Reference (seventy-two entries) 2026</sub>

### 18 / 19 · 'Will it give me cancer?'  
*Your turn · quiz*

One question to close lesson 6.3.

**Q.** Fictional chart note: a 44-year-old using an IGF-1 LR3 product bought online asks you directly whether it causes cancer. Which answer keeps the registers apart?
- ✗ Yes. IGF-1 drives cell growth, so it causes cancer. — *That turns a mechanism into a measured risk. The mechanism is plausible; the effect of this product on cancer has never been studied.*
- ✔ The mechanism makes it a concern; people with higher natural IGF-1 have slightly higher rates of some cancers; IGF-1 LR3 itself has no human studies, so the risk is plausible and unmeasured. — *Correct. Mechanism, observation and the open question, each stated for what it is.*
- ✗ No. Large studies of growth-hormone treatment found no cancer signal. — *Those cohorts studied replacement in children with growth failure, and even they flagged a few signals. They say nothing about an unstudied IGF-1 analogue used for skin.*

### 19 / 19 · Before my next growth-hormone conversation.  
*Closing and commitment · action*
...
- *Clinical staff:* Your checklist ends with escalation: swelling, tingling or new skin changes on a growth-hormone peptide go to the prescriber the same day.
- *Advisor:* Your checklist ends with referral: you can describe the evidence and the US status; anyone injecting these products needs a prescriber.

<sub>Sources: Aesthetic & Regenerative Endocrinology — A Clinician's Pocket Guide 2026 · Katznelson L 2014 · US Food and Drug Administration 2026</sub>


## Module check

**Q.** Closing Module 6: which statement about tesamorelin keeps the four registers apart?
- ✗ Tesamorelin raises growth hormone through the pituitary, so its GRADE A covers skin ageing. — *That stretches a mechanism and an indication-specific grade to a use no trial has tested.*
- ✔ GHRH-receptor agonist (mechanism); GRADE A for HIV-associated abdominal fat (human evidence); FDA-approved in the US for that use since 2010 (regulatory status); whether sustained IGF-1 elevation carries long-term risk is unknown (open question). — *Correct. Four separate answers, each with its own source.*
- ✗ Because it is FDA-approved, tesamorelin is safe to use for skin. — *Approval covers one indication, and its own label lists raised IGF-1, fluid retention and glucose intolerance.*
...
- Four levels, applied to a body of evidence
- Five named reasons to rate down
- The letter belongs to a use, never to a molecule

<details><summary>Narration script</summary>

Every claim you hear about a skin peptide carries a hidden question. How sure can we be? GRADE answers it with four levels of certainty, from high to very low. The rating belongs to a body of evidence for one outcome, such as wrinkle depth at twelve weeks, and never to a single study or to the molecule itself. Randomized trials start high and observational studies start low. From there, certainty drops for five reasons you can name, which are risk of bias, inconsistency between trials, indirectness, imprecision, and suspected publication bias. It can occasionally rise, for example when an effect is very large. Both Hormonaly guides print a letter from A to D beside each use. Read those letters as the same four levels, adapted. They rate the evidence for that use, and they say nothing about whether a product is legal.
...
**1.27** — risk ratio for a favourable efficacy result, industry-sponsored versus other studies (Lundh et al., Cochrane 2017 · 95% CI 1.17–1.37 · moderate-certainty evidence)  
*Means:* When a manufacturer pays for the trial, a favourable result is more likely. Funding is a reason to read a trial harder and to look for independent replication.  
*Does not mean:* It does not make a sponsored trial wrong or an independent one right. It describes an average tilt across many studies and says nothing about any single product.
...
| | | |
|---|---|---|
| Risk of bias | How the trials were run | Flaws in design or conduct that can exaggerate an effect; check whether low- and high-quality trials disagree |
| Inconsistency | The trials disagree | Unexplained differences in results between studies of the same question |
| Indirectness | A different question answered | The studies differ from your question in population, intervention, comparison or outcome |
| Imprecision | Too little data | Too few people or events; the confidence interval spans an important effect and little or none |

**Callout:** Name the reason and you can explain a grade to a patient in one sentence.

**Exercise (quickfire) · Name the problem** — One case at a time: which reason most lowers certainty here?
...
- Grade: certainty for this outcome
- Status: what the law allows, checked separately
- Mechanism never raises a grade

**By role**
- *Prescriber:* Before you recommend or prescribe, write the outcome and its grade in the note, and record the product's regulatory status on a separate line. If no trial addresses the outcome the patient wants, say so and record it.
- *Clinical staff:* When a patient quotes a result, note which outcome it was and where it came from, and pass questions about grades and status to the prescriber rather than rating the product yourself.
- *Advisor:* Describe what a product has been shown to do, for which outcome, and who funded the trials. Leave the question of whether it can lawfully be prescribed to a prescriber.

<details><summary>Narration script</summary>

Suppose a patient asks whether a peptide works. Start with the outcome they care about, say fewer lines around the eyes, and give the certainty for that outcome, along with who paid for the trials behind it. Then, as a separate step, check what the product legally is. The Hormonaly guides keep these two checks apart for a reason. An approved drug can carry a low grade for the particular use a patient has in mind, and a compound with stronger human data may still have no lawful route in the United States. A persuasive mechanism leaves the grade exactly where it is. Whatever your role, say the outcome and the grade in one breath, and treat the regulatory answer as a question of its own.
...
**Q.** A fictional serum's brochure says 'GRADE A: three randomized trials'. All three were run by the maker, enrolled 20 to 30 people each, lasted four weeks and measured skin hydration. Your patient wants fewer wrinkles. What is the most defensible certainty for that outcome?
- ✗ High, because three randomized trials agree. — *Randomized trials start high, but these are small, sponsor-run and measured a different outcome, and each of those lowers certainty.*
- ✔ Low or very low: small sponsor-run trials that measured hydration, not wrinkles. — *Correct. Indirectness (the wrong outcome), imprecision (few people) and suspected publication bias (small industry-funded studies) all rate it down.*
- ✗ It cannot be graded, because industry-funded trials are invalid. — *Sponsored trials are still evidence. Funding is a reason to rate cautiously and to look for replication; it never deletes a trial.*
...
- 503A: patient-specific, three exemptions
- Monograph, then approved component, then the bulks list
- 503B: registered, inspected, held to good manufacturing practice

**Regulatory status by jurisdiction**
- *EU:* In the EU, medicines prepared in a pharmacy on prescription for an individual patient (magistral formulas) or to a pharmacopoeia for the pharmacy's own patients (officinal formulas) are outside Directive 2001/83/EC (Article 3). Pharmacists who prepare medicines solely for retail supply in dispensing pharmacies are also exempt from manufacturing authorisation (Article 40(2)). <sub>(eu-dir-2001-83)</sub>
- *PT:* In Portugal, a magistral formula is prepared in a community or hospital pharmacy on a medical prescription naming the patient, under a pharmacist's responsibility (Decreto-Lei 95/2004). Compounded medicines may use only raw materials listed in the Portuguese or European pharmacopoeia, another European pharmacopoeia or compendial scientific documentation, and one containing any other raw material may not be prescribed. <sub>(pt-dl95-2004 · pt-infarmed-manipulados)</sub>
- *BR:* In Brazil, a magistral preparation is made individually by a pharmacy against a prescription from an authorised professional (RDC 96/2008). ANVISA stated on 2 July 2026 that any substance must have passed efficacy and safety assessment before it can be compounded, and that compounding may take place only individually, on a medical prescription, in a pharmacy licensed by local health surveillance. <sub>(br-rdc-96-2008 · br-anvisa-voto-101-2026 · br-anvisa-peptides-2026)</sub>
- *AE:* In the UAE, where the Emirates Drug Establishment (EDE) has regulated medical products since Federal Decree-Law 28/2023, products compounded in licensed compounding pharmacies are exempt from marketing approval under Federal Decree-Law 38 of 2024 (Art. 5(2)), although such a pharmacy may not copy an EDE-approved product unless no commercial product can deliver the expected benefit, nor formulate products for research, development or experimentation (Art. 95). In Abu Dhabi, the DoH's compounding standard (August 2026) treats peptides as high-risk substances and lets novel substances of unknown risk be compounded only if monographed, a component of an approved medicine or listed on the DoH Registry for Compounded Substances. In Dubai, the DHA prohibits prescribing, dispensing or using any peptide product that is not registered or licensed with the EDE (29 July 2026). <sub>(ae-fdl-28-2023 · ae-fdl-38-2024 · ae-doh-compounding-std-2026 · ae-dha-cir-peptides-2026)</sub>

<details><summary>Narration script</summary>

Two routes exist for compounding in the United States, and the difference between them shapes the rest of this lesson. Under section 503A, a licensed pharmacist or physician prepares a drug for an identified patient on a prescription. If the conditions are met, the product escapes three requirements, namely approval as a new drug, labelling with adequate directions, and good manufacturing practice. The conditions start with the substance itself, taken in strict order. A USP or National Formulary monograph comes first. Only when there is none can it be a component of an approved drug, and only when neither applies can it sit on FDA's 503A bulks list. The substance must also come from a registered manufacturer with a valid certificate of analysis. Section 503B outsourcing facilities work differently. They register with FDA, work to good manufacturing practice, face risk-based inspection, and can compound without a prescription for each patient. Their products remain unapproved.
...
| | | |
|---|---|---|
| 503A bulks list (21 CFR 216.23) | Six substances, none a peptide | Unchanged since 2019. Listing carries no FDA endorsement of safety or efficacy. |
| Category 1 | Under evaluation | FDA does not intend to act against compounders who meet its conditions. GHK-Cu for non-injectable routes is here (list of 14 May 2026). |
| Category 2 | Significant safety risks | Six substances under 503A as of 14 May 2026, kisspeptin-10 among them. |
| Withdrawn nominations | In no category | BPC-157, TB-500, KPV, injectable GHK-Cu, LL-37 and melanotan II among them. FDA's safety concerns stay posted; withdrawal is not clearance. |
| July 2026 advisory committee | Advice only | FDA staff concluded the criteria weigh against listing BPC-157. Only rulemaking changes the list. |

**Callout:** Check the live list on the day you prescribe. GHK-Cu alone moved twice in April and May 2026.

**Regulatory status by jurisdiction**
- *EU:* In the EU, no centrally authorised medicine containing BPC-157, TB-500, KPV, GHK-Cu, LL-37 or melanotan was found in the Union Register or in EMA's data on authorised, refused and withdrawn medicines (searched 25 September 2026). Copper tripeptide-1 (GHK-Cu) is listed in the Commission's CosIng inventory as a cosmetic ingredient with a skin-conditioning function (read 25 September 2026). <sub>(eu-ema-medicines-data · eu-union-register · eu-cosing-copper-tripeptide-1 · eu-cosing-home)</sub>
- *PT:* In Portugal, no medicine containing BPC-157, TB-500, KPV, GHK-Cu, LL-37 or melanotan is listed in INFARMED's Infomed register, which includes authorised, lapsed and revoked products (searched 25 September 2026). <sub>(pt-infomed)</sub>
- *BR:* In Brazil, ANVISA stated on 2 July 2026 that BPC-157 and TB-500 are not authorised as food supplements, and that peptide products such as GHK-Cu, BPC-157, and TB-500 that promise aesthetic effects or improvement in health conditions are not registered with ANVISA. No registered medicine containing KPV, LL-37 or melanotan was found in ANVISA's register (25 September 2026). <sub>(br-anvisa-peptides-2026 · br-anvisa-register-opendata · br-anvisa-register-dictionary · br-anvisa-consultas-medicamentos)</sub>
- *AE:* In the UAE, no registered product containing BPC-157, TB-500, KPV, LL-37, GHK-Cu or melanotan was found in the register of the Emirates Drug Establishment (EDE), the federal regulator of medical products since Federal Decree-Law 28/2023 (searched 25 September 2026). In Dubai, the DHA prohibits any peptide product that is not registered or licensed with the EDE (29 July 2026). In Abu Dhabi, the DoH puts systemic, regenerative or weakly evidenced peptides under enhanced controls (31 July 2026) and requires facilities to prohibit the import, distribution, marketing or use of Melanotan II (2 July 2025). <sub>(ae-fdl-28-2023 · ae-ede-register · ae-doh-cir-112-2025 · ae-dha-cir-peptides-2026 · ae-doh-cir-148-2026)</sub>
...
**40** — amino acids: above this, FDA treats the molecule as a protein, and so as a biological product (85 FR 10057, effective 23 March 2020 · tesamorelin (44 residues) and hyaluronidase moved to biologics licences)  
...
**Regulatory status by jurisdiction**
- *EU:* In the EU, tesamorelin has no marketing authorisation: the application for Egrifta, for excess abdominal fat in HIV patients with lipodystrophy, was withdrawn on 21 June 2012, when the provisional view of EMA's human-medicines committee (CHMP) was that it could not be approved. <sub>(eu-ema-egrifta-withdrawal · eu-union-register)</sub>
- *BR:* In Brazil, no registered medicine containing tesamorelin, including Egrifta, was found in ANVISA's register or online search (25 September 2026). <sub>(br-anvisa-register-opendata · br-anvisa-register-dictionary · br-anvisa-consultas-medicamentos)</sub>
- *AE:* In the UAE, no registered product containing tesamorelin, and none named Egrifta, was found in the register of the Emirates Drug Establishment (EDE), the federal regulator of medical products since Federal Decree-Law 28/2023 (searched 25 September 2026). <sub>(ae-fdl-28-2023 · ae-ede-register)</sub>
...
| | | |
|---|---|---|
| FDA's bulks list and categories | US only | Set under US federal law and FDA policy; no other jurisdiction in this course applies them. |
| The route | A pharmacy preparation or an unlicensed supply | Made or supplied on a prescription, for a product with no marketing authorisation in that jurisdiction. |
| Responsibility | The prescriber's | The prescriber answers for choosing a medicine without a marketing authorisation. |

**Callout:** A 503A category means nothing outside the US: name the route your own law provides, and check it on the day.

**Regulatory status by jurisdiction**
- *GB:* The UK handles unlicensed medicines by a different route. A medicine with no UK marketing authorisation may be supplied to meet one patient's special needs, made to a prescriber's specification by a manufacturer that holds a specials licence, and it may not be advertised. The route (regulation 167): One patient, one prescriber, an unsolicited order. Made to the specification of a doctor, dentist, nurse or pharmacist independent prescriber or supplementary prescriber, for a patient under their direct care. No advertisement may be published. Who makes it: A manufacturer with a specials licence. The site is inspected for good manufacturing practice; the product itself is otherwise unassessed for safety, quality and efficacy. A pharmacist may also prepare a medicine in a registered pharmacy against a prescription. Special need: The patient's clinical need. MHRA's examples include an intolerance or allergy to an ingredient, or an inability to swallow solid doses. Cost, convenience and operational needs do not count. MHRA's order of preference: Licensed, then off-label, then imported, then special. A UK-licensed medicine comes first, even used off-label; then one licensed in its country of origin; then a UK special. Least acceptable are products that are not medicines where they are made, such as supplements. Responsibility: The prescriber's. Be satisfied the evidence supports safety and efficacy, take responsibility for the prescription and the follow-up, record your reasons, and explain them to the patient when the use is not routine. GMC, MHRA and GPhC guidance say this; nurse prescribers work within the NMC Code. Cost and convenience never justify a special, and a licensed option that meets the need comes first. Dated to the Human Medicines Regulations 2012 and MHRA guidance as read on 25 September 2026. <sub>(Human Medicines Regulations 2012 (UK) 2012 · Human Medicines Regulations 2012 (UK) 2012 · Medicines Act 1968 (UK) 1968 · Medicines and Healthcare products Regulatory Agency (UK) 2023 · Medicines and Healthcare products Regulatory Agency (UK) 2009 · General Medical Council (UK) 2021 · General Pharmaceutical Council (UK) 2025 · Nursing and Midwifery Council (UK) 2018)</sub>
- *EU:* In the EU, a member state may, under its own legislation, allow an unauthorised medicine for an individual patient on a bona fide unsolicited order from an authorised health professional, under that professional's direct personal responsibility (Directive 2001/83/EC, Article 5(1)). Medicines prepared in a pharmacy on prescription for an individual patient (magistral formulas) or to a pharmacopoeia for the pharmacy's own patients (officinal formulas) are outside the Directive and need no marketing authorisation under it (Article 3). <sub>(eu-dir-2001-83)</sub>
- *PT:* In Portugal, INFARMED does not authorise the import of medicines for personal use (Circular 148/CD, 29 July 2011), but it may authorise exceptional use (AUE) of a medicine without a marketing authorisation, for example when it is clinically justified as indispensable and no authorised alternative exists (Estatuto do Medicamento). A physician who prescribes a magistral formula must satisfy themselves of its safety and efficacy, including possible interactions (Decreto-Lei 95/2004). <sub>(pt-infarmed-circ148-2011 · pt-dl176-2006 · pt-infarmed-aue · pt-dl95-2004 · pt-infarmed-manipulados)</sub>
- *BR:* In Brazil, unregistered medicines may be imported only exceptionally, for strictly personal use and on a medical prescription, and import by any route is suspended when ANVISA publishes a specific prohibition; ANVISA stated in September 2025 that using an unregistered imported medicine is entirely the responsibility of the patient and the prescribing physician. ANVISA also stated in November 2024 that compounded medicines should be used only when the registered industrial product is unavailable in the dose or dosage form the patient needs. <sub>(br-anvisa-import-pens-2025 · br-anvisa-import-guidance-2025 · br-anvisa-implants-2024)</sub>
- *AE:* In the UAE, Federal Decree-Law 38 of 2024 exempts products compounded in licensed compounding pharmacies from marketing approval (Art. 5(2)) and lets a physician prescribe a product never submitted to the Emirates Drug Establishment (EDE, the federal regulator of medical products since Federal Decree-Law 28/2023) for marketing approval only when necessary, with no equivalent alternative available and with the patient's approval (Art. 42(1)). In Abu Dhabi, the DoH's compounding standard (August 2026) allows compounding only for a genuine, documented clinical need that no suitable licensed product meets, and where permitted it limits prescribing to eligible facilities and credentialed prescribers, office-stock ordering to hospitals and DoH-approved specialty clinics, and dispensing by compounding pharmacies to individual prescriptions. In Dubai, the DHA prohibits any peptide product that is not registered or licensed with the EDE (29 July 2026). <sub>(ae-fdl-28-2023 · ae-fdl-38-2024 · ae-doh-compounding-std-2026 · ae-dha-cir-peptides-2026)</sub>

<sub>Sources: Human Medicines Regulations 2012 (UK) 2012 · Human Medicines Regulations 2012 (UK) 2012 · Medicines Act 1968 (UK) 1968 · Medicines and Healthcare products Regulatory Agency (UK) 2023 · Medicines and Healthcare products Regulatory Agency (UK) 2009 · General Medical Council (UK) 2021 · General Pharmaceutical Council (UK) 2025 · Nursing and Midwifery Council (UK) 2018 · United States Code (as codified) 2026 · US Food and Drug Administration 2026 · eu-dir-2001-83 · pt-dl95-2004 · pt-infarmed-circ148-2011 · br-rdc-96-2008 · br-anvisa-peptides-2026 · br-anvisa-import-pens-2025 · br-anvisa-import-guidance-2025 · ae-fdl-38-2024</sub>
...
- Identity: mass spectrometry, observed against expected
- Purity: an HPLC percentage, impurities unnamed
- Suitability to inject needs sterility, endotoxin and the right lot

<details><summary>Narration script</summary>

Picture the certificate a patient hands you, and read it line by line, asking what each line actually tests. Mass spectrometry checks identity, and a careful certificate shows the expected mass next to the one measured. HPLC reports purity as a percentage of the main peak, which tells you how much else is present and nothing about what that something else is. Endotoxin matters for anything injected, and FDA's guidance says the acceptable limit is calculated from the dose and the route, so a bare figure settles little. When FDA reviewed BPC-157 for its advisory committee, most public certificates listed purity alone, and the one a nominator supplied mentioned no endotoxin test. Then remember what paper cannot do. A certificate describes a lot. It cannot show that your vial came from that lot, how the vial was stored, or that it is sterile.
...
| | | |
|---|---|---|
| Lot number | Printed | Same number as on the vial label |
| Purity (HPLC) | 99.2% | No chromatogram attached |
| Identity (mass spectrometry) | Conforms | Expected and observed mass both printed; spectrum attached |
| Impurities | Not listed | No impurity limits or results |
| Endotoxin | Not tested | Product page describes injection |
| Test date | 20 months before purchase | No retest shown |

**Callout:** A clean certificate is necessary and never sufficient. It cannot make a research-use-only vial sterile, lawful or the lot you think it is.

**Exercise (classify) · Useful or red flag?** — Tap what each line is worth.
- Lot number printed, matching the vial label → **Useful, if it matches the vial** — *A matching lot number links the paper to the product in hand. It is still the supplier's own claim.*
- Purity 99.2% by HPLC, no chromatogram → **Red flag** — *A bare percentage cannot be checked, and it says nothing about which impurities make up the rest.*
- Identity: expected and observed mass printed, spectrum attached → **Useful, if it matches the vial** — *That is how identity is shown. It confirms the molecule and tells you nothing about sterility.*
- Impurities: not listed → **Red flag** — *FDA's reviewers flagged exactly this for BPC-157: purity reported, impurity profile missing, so immunogenic impurities cannot be ruled out.*
- Endotoxin: not tested, on a product sold for injection → **Red flag** — *Endotoxin is a critical attribute for anything injected, and its limit depends on dose and route. 'Not tested' on an injectable is a hard stop.*
- Tested 20 months before purchase → **Red flag** — *Peptides degrade in storage; the Peptide Pocket Guide treats a certificate more than 12 months older than the purchase as a warning sign.*
...
**7.7–14.4%** — measured purity of online semaglutide vials labelled 99% (Ashraf et al., J Med Internet Res 2024 · three delivered vials · endotoxin detected in all three)  
*Means:* Purity printed on a label can be wildly wrong, and a vial that grows nothing can still carry endotoxin. Independent testing found what the paperwork hid.  
*Does not mean:* Three vials of one drug give no market-wide failure rate, and semaglutide is outside the skin-peptide shelf. It documents the gap between claim and content for one product; it does not measure research peptides as a class.
...
- The label permits laboratory research only
- Intended use is read from how a product is sold
- A certificate cannot convert a research product

**By role**
- *Prescriber:* Do not prescribe, supply, supervise or recommend a research-use-only product, and do not read its certificate as permission. Record the product, lot and supplier the patient names, and your advice to stop.
- *Clinical staff:* If a patient brings a research-use-only vial or its certificate, record the product name, lot and supplier exactly as printed, do not handle or administer it, and tell the prescriber the same day.
- *Advisor:* You can explain what a certificate does and does not show. You cannot vouch for a research product, and anyone injecting one should see a prescriber.

**Regulatory status by jurisdiction**
- *EU:* In the EU, a product is a medicine by presentation (presented as treating or preventing disease) or by function (restoring, correcting or modifying physiological functions by a pharmacological, immunological or metabolic action), and where it could be both a medicine and another regulated product, medicines law applies (Directive 2001/83/EC, Articles 1(2) and 2(2)). The Directive's research exclusion covers medicinal products intended for research and development trials (Article 3(3)). <sub>(eu-dir-2001-83)</sub>
- *PT:* In Portugal, a medicine is any substance or combination of substances presented as having properties for treating or preventing disease in human beings or its symptoms, or which may be used in or administered to human beings to make a medical diagnosis or to restore, correct or modify physiological functions by exerting a pharmacological, immunological or metabolic action (Estatuto do Medicamento). Making, selling, supplying or administering medicines without the required authorisations or registrations is an administrative offence punishable by a fine from €2,000 up to 15% of turnover or €180,000, whichever is lower. <sub>(pt-dl176-2006)</sub>
- *BR:* In Brazil, ANVISA stated on 2 July 2026 that some injectable peptides are not regularised in any category (food, medicine, cosmetic or food supplement) and so are illegal for any health use, including aesthetic use. ANVISA also stated in July 2026 that an investigational medicine is used only in authorised clinical research. <sub>(br-anvisa-peptides-2026 · br-anvisa-medicine-types-2026)</sub>
- *AE:* In the UAE, Federal Decree-Law 38 of 2024 has, since 2 January 2025, barred importing, distributing, possessing, selling, displaying or using any medical product without a marketing approval from the Emirates Drug Establishment (EDE), the federal regulator of medical products since Federal Decree-Law 28/2023. In Dubai, the DHA prohibits using any peptide product intended for research use on humans, or for therapeutic purposes outside an approved study or clinical trial, and bars facilities from buying peptide products from websites, social media or unverifiable suppliers (29 July 2026). In Abu Dhabi, the DoH's compounding standard (August 2026) prohibits compounding from unapproved or unknown-source substances, or from substances not on the DoH Registry for Compounded Substances, unless the DoH permits it. <sub>(ae-fdl-28-2023 · ae-fdl-38-2024 · ae-dha-cir-peptides-2026 · ae-doh-compounding-std-2026)</sub>

<details><summary>Narration script</summary>

Research use only sounds like a category. In law it works as a shipping permission. The US rule lets a supplier send an investigational drug for laboratory or test-tube work if the label says it must stay out of people, and the shipper is meant to confirm that is how it will be used. FDA judges what a product is for by how it is marketed and sold, so a disclaimer on a vial offered with injection instructions carries no weight. The Hormonaly guides say it plainly. Research use only is not a clinical pathway. A certificate of analysis, however clean, cannot convert that vial into a pharmaceutical, because sterility, manufacturing standards and a lawful route are all still missing. Whatever your role, treat these products as outside clinical care, and write down exactly what you were told.
...
- Medicine or not: what is claimed, and what it is and does
- No marketing authorisation: no sale, supply or advertising
- Prescription-only: public advertising banned or approved first

**Regulatory status by jurisdiction**
- *GB:* In the UK, MHRA decides whether a product is a medicine from its claims, including websites and social media, and from its form and the way it is used. A medicine with no UK marketing authorisation may not be sold, supplied or advertised. MHRA classes injectable melanotan products as medicines, and its largest seizure of unlicensed weight-loss medicines, in May 2026, included peptide products. Prescription-only medicines may not be advertised to the public at all: a clinic may promote 'treatment for lines and wrinkles' without naming the medicine, and in February 2026 the UK advertising regulator ruled that influencer posts tagging a weight-loss injection were adverts for a prescription-only medicine. GMC guidance requires doctors to examine a patient physically before prescribing an injectable cosmetic medicine. <sub>(Medicines and Healthcare products Regulatory Agency (UK) 2025 · Human Medicines Regulations 2012 (UK) 2012 · Human Medicines Regulations 2012 (UK) 2012 · Medicines and Healthcare products Regulatory Agency (UK) 2024 · Medicines and Healthcare products Regulatory Agency (UK) 2026 · Human Medicines Regulations 2012 (UK) 2012 · Committee of Advertising Practice / Advertising Standards Authority 2026 · Medicines and Healthcare products Regulatory Agency (UK) 2020 · Advertising Standards Authority 2026 · General Medical Council (UK) 2016)</sub>
- *EU:* In the EU, member states must prohibit any advertising of a medicine that has no marketing authorisation, and any advertising of prescription-only medicines to the general public, where advertising includes any inducement designed to promote prescription, supply, sale or consumption (Directive 2001/83/EC, Articles 86 to 88). EU audiovisual law also bans audiovisual commercial communications for prescription-only medicines and medical treatment, and video-sharing platforms must apply this to advertising on their services, including advertising they do not sell themselves (Directive 2010/13/EU). <sub>(eu-dir-2001-83 · eu-dir-2010-13)</sub>
- *PT:* In Portugal, advertising a medicine without a valid national authorisation or registration, or one authorised under Articles 92 and 93, is prohibited, prescription-only medicines may be advertised only in technical media for health professionals, and the advertiser, the agency, anyone disseminating the advertising and the owner of the medium are all liable (Estatuto do Medicamento). Health advertising practices fall under Decreto-Lei 238/2015, which bans false claims of guaranteed cure or results or of absence of side effects and is enforced by the Health Regulatory Authority (ERS). <sub>(pt-dl176-2006 · pt-dl238-2015)</sub>
- *BR:* In Brazil, advertising of prescription-only medicines on the internet must be accessible exclusively to professionals authorised to prescribe or dispense them, through an electronic registration system (RDC 96/2008), and ANVISA restated in November 2024 that advertising compounded products to the public is not permitted. CFM Resolution 2.336/2023 forbids physicians to promote medicines not registered with ANVISA, and ANVISA stated on 2 July 2026 that some injectable peptides are not regularised in any category and so are illegal for any health use, including aesthetic use. <sub>(br-rdc-96-2008 · br-anvisa-implants-2024 · br-cfm-2336-2023 · br-cfm-norms-search · br-anvisa-peptides-2026)</sub>
- *AE:* In the UAE, advertising or promoting any medical product by any means, social media included, needs approval from the Emirates Drug Establishment (EDE), the federal regulator of medical products since Federal Decree-Law 28/2023, and advertising controlled or semi-controlled products to the public is prohibited (Federal Decree-Law 38 of 2024, Art. 44); an EDE advertising licence requires a valid EDE marketing authorisation for the product, apart from products exempted under Article 5(3) of Federal Decree-Law 38 of 2024. In Dubai, the DHA bans misleading or unproven peptide claims, such as anti-ageing, cell regeneration or improved appearance, unless the use is approved within the product's regulatory status, and requires any promotion of unregistered materials, including through influencers, to stop (29 July 2026). In Abu Dhabi, the DoH bars advertising peptide therapies without prior approval from the DoH and relevant authorities (31 July 2026), and its compounding standard (August 2026) bars advertising emerging, non-monographed substances to patients or professionals. <sub>(ae-fdl-28-2023 · ae-fdl-38-2024 · ae-ede-svc-advert · ae-dha-cir-peptides-2026 · ae-doh-cir-148-2026 · ae-doh-compounding-std-2026)</sub>

<details><summary>Narration script</summary>

Selling a peptide outside the United States starts with one question, whether the product is a medicine, and regulators answer it from the product itself. They look at what is claimed for it and at what it is and does, so a research-use label or a cosmetic box settles nothing. A medicine without a marketing authorisation may not be sold, supplied or advertised. Advertising a prescription-only medicine to the public is prohibited, or needs the regulator's approval first, and that covers posts on social media by clinics and influencers. The details differ from country to country, so check the rules for your own jurisdiction, shown with this moment, and date what you find.

</details>

<sub>Sources: Medicines and Healthcare products Regulatory Agency (UK) 2025 · Human Medicines Regulations 2012 (UK) 2012 · Human Medicines Regulations 2012 (UK) 2012 · Human Medicines Regulations 2012 (UK) 2012 · Committee of Advertising Practice / Advertising Standards Authority 2026 · Medicines and Healthcare products Regulatory Agency (UK) 2020 · Advertising Standards Authority 2026 · eu-dir-2001-83 · eu-dir-2010-13 · pt-dl176-2006 · pt-dl238-2015 · br-lei-6360-1976 · br-lei-9294-1996 · br-rdc-96-2008 · br-rdc-907-2024 · br-anvisa-peptides-2026 · br-cfm-2336-2023 · ae-fdl-38-2024 · ae-ede-svc-classification · ae-ede-svc-advert · ae-dha-cir-peptides-2026</sub>
...
**Q.** A patient shows you the certificate for a research-use-only peptide she injects: 99.1% purity by HPLC with a chromatogram, the correct mass by mass spectrometry, and a lot number that matches her vial. What does it establish?
- ✗ That the vial is safe to inject. — *Identity and purity say nothing about sterility, endotoxin or storage, and research-use-only products are labelled not for use in humans.*
- ✔ That the supplier reports the right molecule at high purity for that lot, and nothing about sterility, storage since testing or a lawful route. — *Correct. A certificate describes a lot; it cannot make the product sterile, pharmaceutical or lawful.*
- ✗ Nothing at all, because certificates are always forged. — *Some are unreliable, but a lot-specific certificate with spectra is real information. The problem is what it cannot cover.*
...
- Off-label applies only to approved drugs
- A never-approved peptide has no label
- Compounded is still unapproved

**Regulatory status by jurisdiction**
- *EU:* In the EU, no medicine may be placed on a member state's market without a national marketing authorisation or an EU-wide (central) authorisation (Directive 2001/83/EC, Article 6(1)). A member state may, under its own legislation, allow an unauthorised medicine for an individual patient on a bona fide unsolicited order from an authorised health professional, under that professional's direct personal responsibility (Article 5(1)). <sub>(eu-dir-2001-83)</sub>
- *PT:* In Portugal, marketing a medicine requires INFARMED's authorisation unless the law provides otherwise (Estatuto do Medicamento), and INFARMED may authorise exceptional use (AUE) of a medicine without a marketing authorisation, for example when it is clinically justified as indispensable and no authorised alternative exists. <sub>(pt-dl176-2006 · pt-infarmed-aue)</sub>
- *BR:* In Brazil, ANVISA stated in April 2025 that physicians keep the right to prescribe medicines off-label when they judge that, for a given patient, benefits outweigh risks, while no medicine may be manufactured, sold or supplied before it is registered (Law 6.360/1976, art. 12). ANVISA stated on 2 July 2026 that products presented as peptides including BPC-157 and GHK-Cu that promise aesthetic effects or improvement in health conditions are not registered with ANVISA, and that BPC-157 is not authorised for use as a food supplement. <sub>(br-anvisa-glp1-retention-2025 · br-lei-6360-1976 · br-anvisa-peptides-2026)</sub>
- *AE:* In the UAE, Federal Decree-Law 38 of 2024 lets a physician prescribe a medical product for a use not in its leaflet, or one never submitted to the Emirates Drug Establishment (EDE, the federal regulator of medical products since Federal Decree-Law 28/2023) for marketing approval, only when necessary, when no equivalent alternative is available and with the patient's approval (Art. 42(1)). In Dubai, the DHA prohibits any peptide product that is not registered or licensed with the EDE and requires registered peptide products to be used strictly within their approved indications (29 July 2026). In Abu Dhabi, the DoH allows peptide therapies only for clinical indications supported by available scientific evidence, after a documented eligibility assessment and with informed consent that covers the product's regulatory approval status (31 July 2026). <sub>(ae-fdl-28-2023 · ae-fdl-38-2024 · ae-dha-cir-peptides-2026 · ae-doh-cir-148-2026)</sub>

<details><summary>Narration script</summary>

Off-label is the phrase to get right first. FDA uses it for an approved drug prescribed outside its labelling, which prescribers generally may do when they judge it medically appropriate. The idea assumes a label exists. A peptide that was never approved has none, so prescribing it counts as using an unapproved drug, and the Peptide Pocket Guide says exactly that. Compounding leaves that answer unchanged. A compounded product is unapproved by definition, and it is lawful only when the substance and the pharmacy meet the statute's conditions. Under federal law, putting an unapproved new drug into interstate commerce is a prohibited act, and in 2020 FDA warned a compounding pharmacy about its BPC-157 and GHK-Cu products on that basis. So write the real category in the chart, every time.
...
| | | |
|---|---|---|
| Cosmetic | Appearance claims only | No premarket approval. A claim to affect structure or function, such as 'regenerates cells', makes it a drug; 'cosmeceutical' has no legal meaning. |
| Dietary supplement | Oral, no disease claims | The maker is responsible for safety and labelling before sale; FDA acts after products reach the market. |
| Approved drug | Labelled indications | Off-label use of an approved drug is lawful clinical judgment; document the reasoning. |
| Compounded (503A or 503B) | Unapproved, conditionally lawful | Only when the substance qualifies and the pharmacy meets the statute. Non-injectable GHK-Cu is in Category 1; BPC-157 and TB-500 have no route. |
| Investigational or research use only | Trials, or nothing | Human use belongs in a clinical trial. A 'research use only' vial is outside any clinical route. |

**Callout:** Write the regime in the chart in these words, before anything else.

**Regulatory status by jurisdiction**
- *GB:* The UK sorts products the same way, by claim, form and use, into cosmetics, food and medicines; lesson 7.2 set out its route for unlicensed medicines. <sub>(Medicines and Healthcare products Regulatory Agency (UK) 2025)</sub>
- *EU:* In the EU, a product is a medicine by presentation or by pharmacological, immunological or metabolic function, and where it could also fall under another product law, medicines law applies (Directive 2001/83/EC, Articles 1(2) and 2(2)); anything intended to be ingested, inhaled, injected or implanted is not a cosmetic (Regulation (EC) No 1223/2009, Article 2(2)). Food supplements are foods, and a health claim on a food is prohibited unless it is authorised and on the EU lists of authorised claims (Directive 2002/46/EC; Regulation (EC) No 1924/2006, Article 10(1)). <sub>(eu-dir-2001-83 · eu-reg-1223-2009 · eu-dir-2002-46 · eu-reg-1924-2006)</sub>
- *PT:* In Portugal, INFARMED is the competent authority for cosmetics and states that products administered by ingestion, inhalation, injection or implantation into the body are not cosmetics (read 25 September 2026). Food supplements are meant to maintain the body's homeostasis, not to prevent, treat or cure disease, and must be notified to DGAV before sale; DGAV warns that notification does not mean a supplement is authorised or compliant. <sub>(pt-dl23-2025 · pt-infarmed-cosmetics-faq · pt-dgav-supplements · pt-dgav-notification)</sub>
- *BR:* In Brazil, cosmetic labelling may not carry therapeutic claims for the product or its ingredients (RDC 907/2024, art. 12), and ANVISA stated on 2 July 2026 that injectable cosmetics do not exist and that, if a product is offered in this form, it is an irregular cosmetic. A food supplement is by definition a product for oral ingestion by healthy people (RDC 243/2018), and it may use only constituents on ANVISA's authorised list (IN 28/2018). <sub>(br-rdc-907-2024 · br-anvisa-peptides-2026 · br-anvisa-cosmetics-opendata · br-dou-re-1771-2026 · br-rdc-243-2018 · br-anvisa-supplements-ingredients)</sub>
- *AE:* In the UAE, Federal Decree-Law 38 of 2024 makes cosmetics with a medical effect on the skin, hair or nails, and food supplements, medical products regulated by the Emirates Drug Establishment (EDE, the federal regulator of medical products since Federal Decree-Law 28/2023), while ordinary cosmetics need a MoIAT conformity certificate (Cabinet Resolution 18/2014); an EDE classification letter settles whether a product needs EDE marketing authorisation and in which regulatory category. In Abu Dhabi, the DoH keeps topical cosmetic peptides with no systemic effect on existing pathways as low-risk products, while systemic, regenerative or weakly evidenced peptides face enhanced controls (31 July 2026). <sub>(ae-fdl-28-2023 · ae-fdl-38-2024 · ae-moiat-regulated-products · ae-moiat-ecas-service · ae-ede-svc-classification · ae-doh-cir-148-2026)</sub>
...
- BPC-157 has no approval, so there is no label to go off
- It has no 503A route; FDA staff advised against listing it
- A certificate describes a lot and creates no route

**Exercise (scenario) · What do you do?** — 

A 52-year-old patient, three weeks after a fractional laser treatment, asks you to prescribe compounded BPC-157 injections 'off-label' to speed healing. She has found a pharmacy willing to make it and shows you its certificate of analysis.

- ✗ Prescribe it as off-label use and file the certificate in her chart. — *Off-label presupposes an approved drug. BPC-157 has no approval and no 503A route, FDA has warned a compounder about it, and a certificate changes neither fact.*
- ✔ Decline to prescribe it. Explain the evidence and the US status in plain terms, return to the aftercare plan her treating clinician set, and record her request, what you explained and her decision. — *Right. You keep the conversation, give her the real category and the grade, and leave a chart note a reviewer can follow.*
- ✗ Suggest she buy research-grade BPC-157 with a good certificate and come back for monitoring. — *Research-use-only products are labelled not for use in humans, and the Peptide Pocket Guide treats steering a patient to them as practising medicine, with the liability that follows.*

Follow-up: Chart it in these terms: the product, its regulatory status, the evidence you quoted, the alternatives you discussed and her decision.

**By role**
- *Prescriber:* You decline, explain, and document the request, the product's status in those words, the evidence you quoted and the alternatives you offered.
- *Clinical staff:* If a patient asks you to arrange or give a compounded or research peptide, record the request and the product details and pass it to the prescriber; do not agree to administer it.
- *Advisor:* You explain that BPC-157 has no approval and no lawful compounding route in the US, and that decisions about her healing belong with her treating clinician.

**Regulatory status by jurisdiction**
- *EU:* In the EU, no centrally authorised medicine containing BPC-157 was found in the Union Register or in EMA's data on authorised, refused and withdrawn medicines (searched 25 September 2026). <sub>(eu-ema-medicines-data · eu-union-register)</sub>
- *PT:* In Portugal, no medicine containing BPC-157 is listed in INFARMED's Infomed register, which includes authorised, lapsed and revoked products (searched 25 September 2026). A compounded medicine may use only raw materials listed in the Portuguese or European pharmacopoeia, another European pharmacopoeia or compendial scientific documentation (Decreto-Lei 95/2004). <sub>(pt-infomed · pt-dl95-2004 · pt-infarmed-manipulados)</sub>
- *BR:* In Brazil, ANVISA stated on 2 July 2026 that BPC-157 is not authorised for use as a food supplement, and that any substance must have passed efficacy and safety assessment before it can be compounded. <sub>(br-anvisa-peptides-2026)</sub>
- *AE:* In the UAE, no registered product containing BPC-157 was found in the register of the Emirates Drug Establishment (EDE), the federal regulator of medical products since Federal Decree-Law 28/2023 (searched 25 September 2026). In Dubai, the DHA prohibits any peptide product that is not registered or licensed with the EDE (29 July 2026). In Abu Dhabi, the DoH's compounding standard (August 2026) treats peptides as high-risk substances and lets novel substances of unknown risk be compounded only if monographed, a component of an approved medicine or listed on the DoH Registry for Compounded Substances. <sub>(ae-fdl-28-2023 · ae-ede-register · ae-dha-cir-peptides-2026 · ae-doh-compounding-std-2026)</sub>

<details><summary>Narration script</summary>

A fictional patient, built from this module's sources, is fifty-two and three weeks past a fractional laser treatment. She asks you to prescribe compounded BPC-157 injections off-label to speed her healing. A pharmacy is willing to make it, and she shows you its certificate of analysis. Three facts shape your answer. BPC-157 has never been approved, so there is no label to prescribe around. It has no 503A route, its nominations were withdrawn, and FDA's own reviewers advised against listing it in July 2026, noting a lack of evidence that it works even for the condition they studied. And a certificate describes a batch, which leaves sterility and legality exactly where they were. Decide how you will answer her.
...
**Regulatory status by jurisdiction**
- *EU:* In the EU, a member state may, under its own legislation, allow an unauthorised medicine for an individual patient on a bona fide unsolicited order from an authorised health professional, under that professional's direct personal responsibility (Directive 2001/83/EC, Article 5(1)). <sub>(eu-dir-2001-83)</sub>
- *PT:* In Portugal, a physician who prescribes a magistral formula must satisfy themselves of its safety and efficacy, including possible interactions (Decreto-Lei 95/2004), and a patient-specific exceptional-use authorisation (AUE) always needs an individual clinical justification that the medicine is indispensable (Deliberação 840/2023, 31 August 2023). <sub>(pt-dl95-2004 · pt-infarmed-manipulados · pt-delib840-2023 · pt-infarmed-aue)</sub>
- *BR:* In Brazil, ANVISA stated in September 2025 that using an unregistered imported medicine is entirely the responsibility of the patient and the prescribing physician, and in April 2025 that off-label prescribing of a registered medicine rests on the physician's judgment that, for a given patient, benefits outweigh risks. <sub>(br-anvisa-import-guidance-2025 · br-anvisa-glp1-retention-2025)</sub>
- *AE:* In the UAE, Federal Decree-Law 38 of 2024 allows prescribing outside a product's leaflet, or a product never submitted to the Emirates Drug Establishment (EDE, the federal regulator of medical products since Federal Decree-Law 28/2023) for marketing approval, only when necessary, with no equivalent alternative available and with the patient's approval (Art. 42(1)). In Abu Dhabi, the DoH requires a documented eligibility assessment before peptide therapy and documented informed consent covering expected benefits, uncertainties, risks, alternatives and the product's regulatory approval status (31 July 2026). In Dubai, the DHA does not permit injections or intravenous therapies for 'wellness', 'recovery', 'detoxification' or 'energy enhancement' without a documented medical indication and treatment plan (29 July 2026). <sub>(ae-fdl-28-2023 · ae-fdl-38-2024 · ae-doh-cir-148-2026 · ae-dha-cir-peptides-2026)</sub>
...
**Q.** GHK-Cu appears in three products: a cream sold 'for the look of fine lines', the same cream sold 'to regenerate skin cells', and an injectable vial labelled research use only. In the US, which statement is right?
- ✗ All three are cosmetics, because the molecule is the same. — *The regime follows the claim and the route. A structure-or-function claim makes the second cream a drug, and the vial is no cosmetic at all.*
...
*In every peptide conversation from now on I will …* grade the outcome the patient wants, and name what lowers it · ask who ran and paid for the trials · check the live status with my national regulator on the day (for example FDA or MHRA), and date the check · read a certificate for what it cannot prove · keep research-use-only products out of care · chart the regime, the grade and the consent in plain words

**By role**
- *Prescriber:* Your commitment ends with the chart: the regime, the grade, the consent and a dated status check.
- *Clinical staff:* Your commitment ends with escalation: anything unapproved, compounded or research-use-only goes to the prescriber the same day, with the product details recorded.
...
**Q.** Closing Module 7: which statement keeps evidence, regulatory status and product quality apart?
- ✗ The certificate shows 99% purity, so the peptide is evidence-based and fine to compound. — *That blends product quality into evidence and legality. Purity says nothing about whether it works or whether any route is lawful.*
- ✔ Topical GHK-Cu: small-trial evidence (C); in the US, non-injectable use sits in 503A Category 1, under evaluation; its certificate can show identity and purity, never sterility or legality. — *Correct. Three separate answers, each with its own source.*
