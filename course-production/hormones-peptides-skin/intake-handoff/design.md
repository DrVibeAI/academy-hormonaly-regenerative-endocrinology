---
version: "alpha"
name: "Perceptors — Peptides & Skin Test — Design direction"
...
A shared description of the academy’s visual identity and learning experience. The structured choices below are the current source of truth; the transcript adds context.
...
Use the selected image-to-text balance as a starting point, not a quota. Keep one teaching point per slide when possible. Place explanation near the referenced diagram. For dense reference material, provide a reading view rather than shrinking labels. Preserve semantic colors and typography across every delivery format.
