...
Confirmed by: Fady Hannah-Shmouni, MD FRCPC, 2026-09-25 (final sign-off packet; relayed by Omar Saleem)
...
**Disposition:** CONFIRMED as proposed: keep: absence — PubMed and ClinicalTrials.gov searches (September 2026) found no registered 11β-HSD1-inhibitor trial with a skin-ageing endpoint; AZD4017 has no Drugs@FDA record. No source can state an absence; the course dates it.
...
**Disposition:** CONFIRMED as proposed: keep: full text — Nieman 2008 recommendation 3.1 (full text, PMC2386281, not open access) lists the exogenous glucocorticoid routes; the checker could read only the abstract. Medical owner to confirm against the guideline.
...
**Disposition:** CONFIRMED as proposed: keep: full text — Nieman 2008 recommendations 1.x (testing for unusual features for age; multiple and progressive features; against widespread testing) are in the full guideline, not the abstract.
...
**Disposition:** CONFIRMED as proposed: keep: absence — the approved indications in the menopausal hormone therapy labels (hot flashes, vulvovaginal symptoms, bone) do not include skin; the 2026 labeling change revised warnings and added no indication.
...
**Disposition:** CONFIRMED as proposed: keep: full text — the claim already cites the Endocrine Society guideline (Bornstein 2016), whose full text describes the hyperpigmentation distribution, including sun-exposed areas; the checker could read only its abstract.
...
**Disposition:** CONFIRMED as proposed: keep: full text — Robinson 2005's authors are employees of the company that sells the tested pal-KTTKS product (author affiliations on the paper), which is what 'run by the manufacturer' records.
...
**Disposition:** CONFIRMED as proposed: keep: absence — PubMed and ClinicalTrials.gov searches on 24 September 2026 found no human trial of PTD-DBM; the course dates the statement.
...
**Disposition:** CONFIRMED as proposed: keep: absence — a PubMed search (September 2026) found one indexed randomized trial of topical GHK-Cu (Miller 2006); the course states the date of the search.
...
**Disposition:** CONFIRMED as proposed: keep: full text — both LL-37 trials were run by the developer (Grönberg 2014 by Lipopeptide AB, its predecessor company; Mahlapuu 2021 by Promore Pharma), per the papers' affiliations and funding statements.
...
**Disposition:** CONFIRMED as proposed: keep: standard knowledge — postpartum or post-diet telogen effluvium and smooth patchy alopecia areata (beard or scalp, nail pitting) are standard clinical presentations; they match the Hormonaly guide's hair-loss algorithm (p. 93, an image the checker cannot read).
